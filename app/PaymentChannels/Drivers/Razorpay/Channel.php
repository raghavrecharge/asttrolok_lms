...
private function sendToExternalServices($user, $payment, $order_item)
{
    try {
        ...
        $listId = empty($user->pwd_hint) ? '143046' : '146283'; // Choose list ID based on condition
        $contactData = [
            'email' => $user->email,
            'fields' => [
                '941988' => $user->full_name,
    ...
    try {
        ...
        $gohighlevelUrl = 'https://services.leadconnectorhq.com/hooks/eAE21tVIbkFC6dUHwja9/webhook-trigger/01b4e1c3-dd79-41a9-b383-cc485d4b917b';
...
// print_r($order);die;
    ...
    try {
        if (!empty($input['razorpay_payment_id'])) {
            ...
            try {
                $vboutService = new VboutService();
                $listId = empty($user->pwd_hint) ? '143046' : '146283';
                $fields = empty($user->pwd_hint) ? [
                    '941988' => $user->full_name,
                    '941989' => $payment['description'],
                    '941991' => $payment['amount'] / 100,
                    '941992' => dateTimeFormat(time(), 'j M Y H:i'),
            ...
            try {
                ...
                $ch = curl_init('https://services.leadconnectorhq.com/hooks/eAE21tVIbkFC6dUHwja9/webhook-trigger/01b4e1c3-dd79-41a9-b383-cc485d4b917b');
