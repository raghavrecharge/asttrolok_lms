...
class SettingsController extends Controller
{
    ...
    public function personalizationPage(Request $request, $name)
    {
        try {
            ...
            \Log::error('personalizationPage error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function storeSeoMetas(Request $request)
    {
        try {
            ...
            \Log::error('storeSeoMetas error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
     ...
     public function editSidebanner($sidebanner_key)
    {
        try {
            ...
            \Log::error('editSidebanner error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
      ...
      public function storeSidebanner(Request $request)
    {
        try {
            ...
            \Log::error('storeSidebanner error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function editSocials($social_key)
    {
        try {
            ...
            \Log::error('editSocials error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function deleteSocials($social_key, $locale = null)
    {
        try {
            ...
            \Log::error('deleteSocials error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function storeSocials(Request $request)
    {
        try {
            ...
            \Log::error('storeSocials error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function storeCustomCssJs(Request $request)
    {
        try {
            ...
            \Log::error('storeCustomCssJs error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function notificationsMetas(Request $request)
    {
        try {
            ...
            \Log::error('notificationsMetas error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function homeSliderEdit(Request $request, $id)
    {
        try {
            ...
            \Log::error('homeSliderEdit error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function homeSliderDelete($id)
    {
        try {
            ...
            \Log::error('homeSliderDelete error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
