...
trait FinancialCurrencySettings
{
    public function financialCurrencyStore(Request $request)
    {
        try {
            ...
            \Log::error('financialCurrencyStore error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
    ...
    public function financialCurrencyEdit($id)
    {
        try {
            ...
            \Log::error('financialCurrencyEdit error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function financialCurrencyDelete($id)
    {
        try {
            ...
            \Log::error('financialCurrencyDelete error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function financialCurrencyOrderItems(Request $request)
    {
        try {
            ...
            \Log::error('financialCurrencyOrderItems error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
