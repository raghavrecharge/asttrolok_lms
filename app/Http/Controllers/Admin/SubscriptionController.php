...
class SubscriptionController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        // print_r($subscription->subscriptionWebinars);
        // die();
        ...
        // echo "<pre>";
        // print_r($quizzes->where('chapter_id',$chapter->id));
        // die();
        ...
        // if(!(SubscriptionWebinarChapterItems::where('subscription_id',$subscription->id)->where('chapter_id',$chapter->id)->where('item_id',$chapterItems->item_id)->where('webinar_id',$chapter->webinar_id)->first()))
        // {
        if(empty(SubscriptionWebinarChapterItems::where('subscription_id',$subscription->id)
                ->where('item_id', $chapterItems->item_id)->first())){
                    $count++;
        SubscriptionWebinarChapterItems::Create([
            ...
            //  if($quizzes->where('chapter_id',$chapter->id)){
            //  $quizzes1 =$quizzes->where('chapter_id',$chapter->id);
            // //  print_r($quizzes1);
...
//         'file_title'      => optional($item->file)->title ?? null,
//     ];
