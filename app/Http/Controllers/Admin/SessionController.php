        ...
        try {
            ...
            if (!empty($data['webinar_id'])) {
                ...
                if (!empty($webinar)) {
                    ...
                    if (!empty($data['session_api']) and $data['session_api'] == 'zoom' and (empty($teacher->zoomApi) or empty($teacher->zoomApi->api_key) or empty($teacher->zoomApi->api_secret))) {
                        $error = [
                    ...
                    if ($data['session_api'] == 'big_blue_button') {
                        ...
                        $this->handleZoomApi($session, $teacher);
