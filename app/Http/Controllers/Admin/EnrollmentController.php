...
class EnrollmentController extends Controller
{
    ...
    public function addStudentToClass()
    {
        try {
            ...
            \Log::error('addStudentToClass error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
  ...
  public function store1(Request $request)
    ...
    public function blockAccess($saleId)
    {
        try {
            ...
            \Log::error('blockAccess error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function enableAccess($saleId)
    {
        try {
            ...
            \Log::error('enableAccess error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function exportExcel112()
    {
        try {
            ...
            \Log::error('exportExcel112 error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
     ...
     public function courseAccessImport(Request $request)
    {
        try {
            ...
            \Log::error('courseAccessImport error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
