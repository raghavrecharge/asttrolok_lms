...
class WebinarController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $webinar = Webinar::where('id', $id)
            ...
            ->first();
// print_r($webinar->chapters->chapterItems);die();
        if (empty($webinar)) {
            abort(404);
        }
    ...
    public function studentsLists1(Request $request, $id)
    {
        ...
        if (!empty($webinar)) {
            ...
            // $data = [
            //     'test' => trans('admin/main.students'),
            // ];
            ...
            foreach($students as $student){
                ...
                // print_r($gohighleveldata['full_name']);
                ...
                'chapters' => function ($query) use ($user) {
                    ...
                    $query->with([
                        'chapterItems' => function ($query) {
                            ...
                            // $query->with([
                            //     'CourseProgress' => function ($query) {
                                    
                                    
                            //         $query->join('chapterItems', 'chapterItems.id', '=', 'CourseProgress.item_id')             //course_progress
                            //             ->where('webinars.id', 'CourseProgress.webinar_id');
