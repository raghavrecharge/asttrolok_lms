...
trait InstallmentsTrait
{
    public function getInstallmentsByCourse(Request $request)
    {
        try {
            ...
            \Log::error('getInstallmentsByCourse error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
    ...
    public function getInstallmentsByProduct(Request $request, $slug)
    {
        try {
            ...
            \Log::error('getInstallmentsByProduct error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function getInstallmentsByRegistrationPackage($packageId)
    {
        try {
            ...
            \Log::error('getInstallmentsByRegistrationPackage error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function getInstallmentsBySubscribe($subscribeId)
    {
        try {
            ...
            \Log::error('getInstallmentsBySubscribe error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
     ...
     public function installmentContentLimitation_check($itemId = null)
    {
        try {
            ...
            \Log::error('installmentContentLimitation_check error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function installmentContentLimitation_check_step($userid = null, $instid = null, $webid = null)
    {
        try {
            ...
            \Log::error('installmentContentLimitation_check_step error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
