...
class LoginController extends Controller
{
    ...
    public function afterLogged(Request $request, $verify = false)
    {
        try {
            ...
            // Mentor role auto-revert if all courses expired
            if (method_exists($user, 'checkAndRevertMentorRoleIfAllCoursesExpired')) {
                $user->checkAndRevertMentorRoleIfAllCoursesExpired();
            }
