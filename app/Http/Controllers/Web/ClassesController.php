...
class ClassesController extends Controller
{
    ...
    public function forgetAllCache()
    {
        try {
            ...
            \Log::error('forgetAllCache error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function forgetClassesCache()
    {
        try {
            ...
            \Log::error('forgetClassesCache error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function forgetUserCache($userId = null)
    {
        try {
            ...
            \Log::error('forgetUserCache error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function forgetDiscountCache()
    {
        try {
            ...
            \Log::error('forgetDiscountCache error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
