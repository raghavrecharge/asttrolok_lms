...
class ProductController extends Controller
{
    ...
    public function searchLists(Request $request)
    {
        try {
            ...
            if ($agent->isMobile()){
                ...
                return view('web.default2' . '.products.search', $data);
            }
        } catch (\Exception $e) {
            \Log::error('searchLists error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
    ...
    public function show($slug)
    {
        try {
            ...
            $pageRobot = getPageRobot('product_show');
            ...
            if ($agent->isMobile()){
                ...
                return view('web.default2' . '.products.show', $data);
            }
        } catch (\Exception $e) {
