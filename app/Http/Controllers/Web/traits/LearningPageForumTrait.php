...
trait LearningPageForumTrait
{
    public function forum(Request $request, $slug)
    {
        try {
            ...
            \Log::error('forum error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
    ...
    public function forumStoreNewQuestion(Request $request, $slug)
    {
        try {
            ...
            \Log::error('forumStoreNewQuestion error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function getForumForEdit($slug, $forumId)
    {
        try {
            ...
            \Log::error('getForumForEdit error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function updateForum(Request $request, $slug, $forumId)
    {
        try {
            ...
            \Log::error('updateForum error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function forumPinToggle(Request $request, $slug, $forumId)
    {
        try {
            ...
            \Log::error('forumPinToggle error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function forumDownloadAttach($slug, $forumId)
    {
        try {
            ...
            \Log::error('forumDownloadAttach error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function getForumAnswers($slug, $forumId)
    {
        try {
            ...
            \Log::error('getForumAnswers error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function storeForumAnswers(Request $request, $slug, $forumId)
    {
        try {
            ...
            \Log::error('storeForumAnswers error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function answerTogglePinOrResolved(Request $request, $slug, $forumId, $answerId, $togglePinOrResolved)
    {
        try {
            ...
            \Log::error('answerTogglePinOrResolved error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
