...
class BundleController extends Controller
{
    ...
    foreach ($bundle->bundleWebinars as $bw) {
        // Filter consultations by the $type parameter
        ...
        if ($bw->consultation_type === 'specific' && $bw->consultant_id) {
            ...
            // Calculate max amount for DB filtering to accommodate slotTime price scaling
            $maxAmount = $bw->ending_price * (30 / $slotTime2);

            // Query users with meeting amount in the roughly expanded range
            ...
            // Filter users by exact slot time adjusted price within range
