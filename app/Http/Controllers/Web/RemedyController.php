...
class RemedyController extends Controller
{
    ...
    public function remedy($slug, $justReturnData = false)
    {
        try {
            ...
            $seoSettings = getSeoMetas('remedies');
            ...
            $pageRobot = getPageRobot('remedies');
    ...
    public function remedies(Request $request,$slug='')
    {
        try {
            ...
            $data = [
                ...
                'pageRobot' => $pageRobot,
                'remedies' => $remedies,
                'coursesCount' => $remedies->total(),
                'slug' =>"/".$slug,
                'page' =>'remedies'
            ];
            $agent = new Agent();
                    if ($agent->isMobile()){
                        return view(getTemplate() . '.pages.remedies', $data);
                }else{
                    return view('web.default2' . '.pages.remedies', $data);
                }
        } catch (\Exception $e) {
