...
class UserController extends Controller
{
    ...
    public function updateMeta(Request $request, $meta_id)
    {
        try {
            ...
            \Log::error('updateMeta error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function manageUsers(Request $request, $user_type)
    {
        try {
            ...
            \Log::error('manageUsers error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function editUser($user_type, $user_id, $step = 1)
    {
        try {
            ...
            \Log::error('editUser error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function contactInfo(Request $request)
    {
        try {
            ...
            \Log::error('contactInfo error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function offlineToggle(Request $request)
    {
        try {
            ...
            \Log::error('offlineToggle error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
