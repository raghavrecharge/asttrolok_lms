...
class MeetingController extends Controller
{
    public function setting(Request $request)
    {
        try {
            ...
            $meetingTimes = [];
            foreach ($meeting->meetingTimes->where('disabled',0)->groupBy('day_label') as $day => $meetingTime) {
    ...
    public function saveTime(Request $request)
    {
        try {
            ...
            \Log::error('saveTime error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function deleteTime(Request $request)
    {
        try {
            ...
            \Log::error('deleteTime error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function temporaryDisableMeetings(Request $request)
    {
        try {
            ...
            \Log::error('temporaryDisableMeetings error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
