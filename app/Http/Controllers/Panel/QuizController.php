...
class QuizController extends Controller
{
        ...
        try {
            ...
            if ($quiz) {
                ...
                if (!empty($quiz->webinar_id)) {
                    ...
                    if (empty($subscription_id) and !$checkUserHasBought) {
                        $toastData = [
    ...
    public function opens(Request $request)
    {
        try {
            ...
            \Log::error('opens error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function showResult($quizResultId)
    {
        try {
            ...
            \Log::error('showResult error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function destroyQuizResult($quizResultId)
    {
        try {
            ...
            \Log::error('destroyQuizResult error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    public function editResult($quizResultId)
    {
        try {
            ...
            \Log::error('editResult error: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
                'trace' => $e->getTraceAsString()
            ]);
