...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Events 167 - 176
        Section::updateOrCreate(['id' => 167], ['name' => 'admin_events', 'caption' => 'Events']);
        Section::updateOrCreate(['id' => 168], ['name' => 'admin_events_list', 'section_group_id' => 167, 'caption' => 'Events List']);
        Section::updateOrCreate(['id' => 169], ['name' => 'admin_events_create', 'section_group_id' => 167, 'caption' => 'Create Event']);
        Section::updateOrCreate(['id' => 170], ['name' => 'admin_events_edit', 'section_group_id' => 167, 'caption' => 'Edit Event']);
        Section::updateOrCreate(['id' => 171], ['name' => 'admin_events_delete', 'section_group_id' => 167, 'caption' => 'Delete Event']);
        Section::updateOrCreate(['id' => 172], ['name' => 'admin_events_toggle_status', 'section_group_id' => 167, 'caption' => 'Toggle Event Status']);
        Section::updateOrCreate(['id' => 173], ['name' => 'admin_events_regenerate_link', 'section_group_id' => 167, 'caption' => 'Regenerate Payment Link']);
        ...
        // Gifts 3040 - 3089
        Section::updateOrCreate(['id' => 3040], ['name' => 'admin_remedies', 'caption' => 'Remedies']);
        Section::updateOrCreate(['id' => 3041], ['name' => 'admin_remedies_list', 'section_group_id' => 3040, 'caption' => 'List']);
        Section::updateOrCreate(['id' => 3042], ['name' => 'admin_remedies_create', 'section_group_id' => 3040, 'caption' => 'Remedies create']);
        Section::updateOrCreate(['id' => 3043], ['name' => 'admin_remedies_edit', 'section_group_id' => 3040, 'caption' => 'Remedies Edit']);
        Section::updateOrCreate(['id' => 3044], ['name' => 'admin_remedies_delete', 'section_group_id' => 3040, 'caption' => 'Remedies Delete']);
