    ...
    Route::group(['prefix' => 'captcha'], function () {
            ...
            Route::group(['prefix' => 'dashboard'], function () {
                ...
                Route::group(['prefix' => 'users'], function () {
                    ...
                    Route::get('/{id}/{slug}/courseprogress', 'UserController@courseprogress');
                    Route::get('/{id}/{slug}/sub-courseprogress', 'UserController@subcourseprogress');
                    Route::get('/{id}/editinsta/{instaid}', 'UserController@editinsta');
                    ...
                    // Quick Support Form routes
                    Route::get('/quick-support-form', 'AdminSupportController@quickSupportForm')
                        ->name('admin.support.quickSupportForm');
                    Route::post('/quick-support-form/grant-access', 'AdminSupportController@grantQuickAccess')
                        ->name('admin.support.grantQuickAccess');
                    ...
                    Route::group(['prefix' => 'departments'], function () {
                        ...
                        Route::group(['prefix' => 'newsuportforasttrolok'], function () {
                            ...
                            Route::get('/support/{id}', 'AdminSupportController@show')
                                ->name('admin.support.show');

                            Route::put('/support/{id}/status', 'AdminSupportController@updateStatus')
                ...
                Route::group(['prefix' => 'comments/{page}'], function () {
                    ...
                    Route::get('/analytics', 'ReportsController@analytics');
                    ...
                    Route::get('/{id}/excel', 'WebinarController@exportExcelStudents');
                    ...
                    Route::get('/', 'RemedyController@index');
                    Route::get('/create', 'RemedyController@create');
                    Route::post('/store', 'RemedyController@store');
                    Route::get('/{id}/edit', 'RemedyController@edit');
                    Route::post('/{id}/update', 'RemedyController@update');
                    Route::get('/{id}/delete', 'RemedyController@destroy');
                    Route::get('/{id}/approve', 'RemedyController@approve');
                    Route::get('/{id}/reject', 'RemedyController@reject');
                    Route::get('/{id}/unpublish', 'RemedyController@unpublish');
                    Route::post('/search', 'RemedyController@search');
                    Route::get('/excel', 'RemedyController@exportExcel');
                    Route::get('/{id}/students', 'RemedyController@studentsLists');
                    Route::get('/{id}/sendNotification', 'RemedyController@notificationToStudents');
                    Route::post('/{id}/sendNotification', 'RemedyController@sendNotificationToStudents');
                    Route::post('/add-student-to-course', 'RemedyController@addStudentToCourse');
                    Route::post('/order-items', 'RemedyController@orderItems');
                    Route::post('/{id}/getContentItemByLocale', 'RemedyController@getContentItemByLocale');
                ...
                Route::group(['prefix' => 'quizzes'], function () {
                    ...
                    Route::get('/{id}/copy', 'QuizController@copy');
                ...
                Route::group(['prefix' => 'chapters'], function () {
                    ...
                    Route::post('/{id}/remediesupdate', 'ChapterController@update_remedies');
                    Route::get('/{id}/delete', 'ChapterController@destroy');
                    Route::post('/change', 'ChapterController@change');
                }
                );

                Route::group(['prefix' => 'rechapter'], function () {
                    Route::get('/{id}', 'RechapterController@getChapter');
                    Route::get('/getAllByWebinarId/{webinar_id}', 'RechapterController@getAllByWebinarId');
                    Route::post('/store', 'RechapterController@store');
                    Route::post('/{id}/edit', 'RechapterController@edit');
                    Route::post('/{id}/update', 'RechapterController@update');
                    Route::get('/{id}/delete', 'RechapterController@destroy');
                    Route::post('/change', 'RechapterController@change');
                }
                );
                ...
                Route::group(['prefix' => 'refiles'], function () {
                    Route::post('/store', 'RefileController@store');
                    Route::post('/{id}/edit', 'RefileController@edit');
                    Route::post('/{id}/update', 'RefileController@update');
                    Route::get('/{id}/delete', 'RefileController@destroy');
                }
                );
                ...
                Route::group(['prefix' => 'consultation-seo'], function () {
                    Route::get('/', 'ConsultationSeoController@index');
                    Route::get('/create', 'ConsultationSeoController@create');
                    Route::post('/store', 'ConsultationSeoController@store');
                    Route::post('/search', 'ConsultationSeoController@search');
                    Route::get('/{id}/edit', 'ConsultationSeoController@edit');
                    Route::post('/{id}/update', 'ConsultationSeoController@update');
                    Route::get('/{id}/delete', 'ConsultationSeoController@delete');
                }
                );
                ...
                Route::group(['prefix' => 'blog'], function () {
                    ...
                    Route::get('/import', 'BlogController@importview');
                    Route::post('/importExcel', 'BlogController@importExcel');
                    ...
                    Route::group(['prefix' => 'price-overrides'], function () {
                    Route::get('/', 'PriceOverrideController@index');
                    Route::post('/store', 'PriceOverrideController@store');
                    Route::get('/{id}/edit', 'PriceOverrideController@edit');
                    Route::post('/{id}/update', 'PriceOverrideController@update');
                    Route::get('/{id}/delete', 'PriceOverrideController@destroy');
                    Route::post('/bulk-import', 'PriceOverrideController@bulkImport');
                }
                );
                        ...
                        Route::group(['prefix' => 'installments'], function () {
                            ...
                            Route::group(['prefix' => 'settings'], function () {
                                ...
                                Route::group(['prefix' => 'orders'], function () {
                                    ...
                                    Route::post('/{id}/log-payment', 'InstallmentsController@logPayment');
                                ...
                                Route::post('/purchases/store', 'InstallmentsController@storePurchase');
                ...
                Route::group(['prefix' => 'additional_page'], function () {
                    ...
                    Route::group(['prefix' => 'personalization'], function () {
                        ...
                        Route::group(['prefix' => 'home_slider'], function () {
                            Route::get('/{id}/edit', 'SettingsController@homeSliderEdit');
                            Route::post('/', 'SettingsController@storeNavbarButtonSettings');
                            Route::get('/{id}/delete', 'SettingsController@homeSliderDelete');
                        }
                        );
                        ...
                        Route::group(['prefix' => '/sidebanner'], function () {
                            Route::post('/store', 'SettingsController@storeSidebanner');
                            Route::get('/{key}/edit', 'SettingsController@editSidebanner');
                            Route::get('/{key}/delete', 'SettingsController@deleteSidebanner');
                        }
                        );
                    ...
                    Route::get('/video', 'TestimonialsController@video');
                    ...
                    Route::group(['prefix' => '/video'], function () {
                            Route::post('/store', 'TestimonialsController@storeVideo');
                            Route::get('/{key}/edit', 'TestimonialsController@editVideo');
                            Route::get('/{key}/delete', 'TestimonialsController@deleteVideo');
                        }
                        );
                    }
                    );
                ...
                Route::group(['prefix' => 'bundle-products'], function () {
                    Route::post('/store', 'BundleWebinarsController@storeProduct');
                    Route::post('/{id}/edit', 'BundleWebinarsController@edit');
                    Route::post('/{id}/update', 'BundleWebinarsController@updateProduct');
                    Route::get('/{id}/delete', 'BundleWebinarsController@destroy');
                }
                );

                Route::group(['prefix' => 'bundle-consultations'], function () {
                    Route::post('/store', 'BundleWebinarsController@storeConsultation');
                    Route::post('/{id}/edit', 'BundleWebinarsController@edit');
                    Route::post('/{id}/update', 'BundleWebinarsController@updateConsultation');
                    Route::get('/{id}/delete', 'BundleWebinarsController@destroy');
                }
                );
                ...
                Route::group(['prefix' => 'subscription-webinars'], function () {
                    Route::post('/store', 'SubscriptionWebinarsController@store');
                    Route::post('/{id}/edit', 'SubscriptionWebinarsController@edit');
                    Route::post('/{id}/update', 'SubscriptionWebinarsController@update');
                    Route::get('/{id}/delete', 'SubscriptionWebinarsController@destroy');
                }
                );
                ...
                Route::group(['prefix' => 'enrollments'], function () {
                    ...
                    Route::post('/import', 'EnrollmentController@courseAccessImport');
                }
                );
                ...
                Route::group(['prefix' => 'upcoming_courses'], function () {
                    ...
                    Route::get('/', 'OfflinePaymentController@adminIndex')->name('admin.offline_payments.index');
                    Route::get('/{paymentId}', 'OfflinePaymentController@adminShow')->name('admin.offline_payments.show');
                    Route::post('/{paymentId}/approve', 'OfflinePaymentController@approve')->name('admin.offline_payments.approve');
                ...
                Route::group(['prefix' => 'events'], function () {
                    ...
                    Route::get('/{id}/edit', 'EventController@edit')->name('admin.events.edit');
                    Route::put('/{id}/update', 'EventController@update')->name('admin.events.update');
