...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance']], function () {
    ...
    Route::get('/bundle/{id}', 'DashboardController@bundledata');
  Route::get('/supports/{id}/', 'DashboardController@dashboard');
     Route::post('/supports/{id}/', 'DashboardController@storeConversations');
     Route::get('/supports/{id}/close', 'DashboardController@close');
    ...
    Route::group(['prefix' => 'webinars'], function () {
        ...
        Route::get('/{id}/bundle/{sale_id}/invoice', 'WebinarController@invoice_bundle');
        Route::get('/{id}/part/{sale_id}/invoice', 'WebinarController@invoice_part');
        Route::get('/{id}/meeting/{sale_id}/invoice', 'WebinarController@invoice_meeting');
        Route::get('/{id}/subscription/{sale_id}/invoice', 'WebinarController@invoice');
        Route::get('/{id}/bundle/{sale_id}/invoice', 'WebinarController@invoice');
    ...
    Route::group(['prefix' => 'support'], function () {
        ...
        Route::get('/new-suport', 'SupportsController@createnewsuport');
        Route::post('/store-suport', 'SupportsController@store');
        ...
        // Installment restructure API routes
        Route::get('/installment-orders', 'SupportsController@getInstallmentOrders');
        Route::get('/installment-steps/{orderId}', 'SupportsController@getInstallmentSteps');

        Route::group(['prefix' => 'tickets'], function () {
            Route::get('/', 'SupportsController@tickets');
            Route::get('{id}/conversations', 'SupportsController@tickets');
        });
        Route::get('/get-user-installment-orders',  'NewSupportForAsttrolokController@getUserInstallmentOrders')
        ->name('newsuportforasttrolok.get-user-installment-orders');

        Route::group(['prefix' => 'newsuportforasttrolok'], function () {
           Route::get('/new-suport', 'NewSupportForAsttrolokController@create')->name('newsuportforasttrolok.create');
           Route::post('/store', 'NewSupportForAsttrolokController@store');
            Route::get('/categories',  'NewSupportForAsttrolokController@getCategories')
        ->name('newsuportforasttrolok.categories');

        Route::post('/validate-coupon', 'NewSupportForAsttrolokController@validateCoupon');

        Route::get('/{ticketNumber}',  'NewSupportForAsttrolokController@show')
            ->name('newsuportforasttrolok.show');

            Route::get('/show/{ticketNumber}',  'NewSupportForAsttrolokController@show')
            ->name('newsuportforasttrolok.show');

             Route::get('/',  'NewSupportForAsttrolokController@index')
            ->name('newsuportforasttrolok.index');




             Route::get('/get-users-installment-orders', 'NewSupportForAsttrolokController@getUserInstallmentOrders');
            Route::get('/get-installment-details/{orderId}', 'NewSupportForAsttrolokController@getInstallmentDetails');
            Route::get('/get-available-installment-plans/{courseId}', 'NewSupportForAsttrolokController@getAvailableInstallmentPlans');
                    
            Route::post('/calculate-restructure-preview', 'NewSupportForAsttrolokController@calculateRestructurePreview')
                ->name('calculate_restructure_preview');
            
            Route::post('/validate-restructure-request', 'NewSupportForAsttrolokController@validateRestructureRequest')
                ->name('validate_restructure_request');
    ...
    Route::group(['prefix' => 'blog'], function () {
     ...
     Route::post('/store-watched-duration', 'WebinarController@storeWatchedDuration')->name('store.watched.duration');
     Route::post('/store-watched-duration-sub', 'WebinarController@storeWatchedDurationSubscription')->name('store.watched.duration.sub');
