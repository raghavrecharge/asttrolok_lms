...
/***/ "./resources/js/parts/product_show.js":
/*!********************************************!*\
  !*** ./resources/js/parts/product_show.js ***!
  \********************************************/
...
(function () {
  ...
  $('body').on('click', '.product-show-thumbnail-card .thumbnail-card', function (e) {
    ...
    var $productDemoVideoBtn = $('#productDemoVideoBtn');
  ...
  function handleQuantityValue(type) {
    var input = $('.cart-quantity input[name="quantity"]');
    var value = input.val();
  ...
  $('body').on('click', '.js-installments-btn', function (e) {
    ...
    var specifications = $('.selectable-specification-item input:checked');
    var path = href + '?quantity=' + quantity;

    if (specifications.length) {
      var _iterator2 = _createForOfIteratorHelper(specifications),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var specification = _step2.value;
...
/***/ 0:
/*!**************************************************!*\
  !*** multi ./resources/js/parts/product_show.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/rocket/projects/webinar/resources/js/parts/product_show.js */"./resources/js/parts/product_show.js");
