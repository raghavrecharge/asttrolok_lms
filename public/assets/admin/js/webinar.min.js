...
(function ($) {
  ...
  * */
  ...
  /**
   * FAQ & Why Choose Us - COMPLETE IMPLEMENTATION
   * */
  $('body').on('click', '#webinarAddFAQ', function (e) {
    ...
    Swal.fire({
      ...
      width: '48rem',
      onOpen: function onOpen() {
        console.log('FAQ modal opened - adding type field');
        var typeInput = '<input type="hidden" name="type" value="faq">';
        $('#addFAQsModal .js-faq-form').append(typeInput);
        console.log('Type field added:', $('#addFAQsModal input[name="type"]').val());
      }
    });
  });

  $('body').on('click', '#webinarAddWhyChooseUs', function (e) {
    e.preventDefault();
    console.log('Why Choose Us button clicked!');
    var add_why_modal = '<div id="addFAQsModal">';
    add_why_modal += $('#webinarFaqModal').html();
    add_why_modal += '</div>';
    add_why_modal = add_why_modal.replace('Add FAQ', 'Add Why Choose Us');
    Swal.fire({
      html: add_why_modal,
      showCancelButton: false,
      showConfirmButton: false,
      ...
      width: '48rem',
      onOpen: function onOpen() {
        console.log('Why Choose Us modal opened!');
        var typeInput = '<input type="hidden" name="type" value="why_choose_us">';
        $('#addFAQsModal .js-faq-form').append(typeInput);
        console.log('Type field added:', $('#addFAQsModal input[name="type"]').val());
      }
    });
  ...
  * */
  function editFaq($this) {
    ...
    $.post(adminPanelPrefix + '/faqs/' + faq_id + '/edit', edit_data, function (result) {
      if (result && result.faq) {
        ...
        // Title change based on type
        if (faq.type === 'why_choose_us') {
          edit_faq_modal = edit_faq_modal.replace('Add FAQ', 'Edit Why Choose Us');
        } else {
          edit_faq_modal = edit_faq_modal.replace('Add FAQ', 'Edit FAQ');
        }
        ...
        Swal.fire({
          ...
          onOpen: function onOpen() {
            ...
            // Add type field
            var typeInput = '<input type="hidden" name="type" value="' + faq.type + '">';
            $modal.find('.js-faq-form').append(typeInput);
  ...
  $('body').on('click', '.edit-faq, .edit-why-choose-us', function (e) {
    e.preventDefault();
    var $this = $(this);
    editFaq($this);
  });
