            ...
            return {
                addHandler: function (t) {
                    if ("function" == typeof t) {
                        for (var i = 0; i < e.length; i++) if (e[i] === t) return void console.log("The handler already in the list");
                        e.push(t);
                    } else console.log("The handler must be a function");
                },
                removeHandler: function (t) {
                    for (var i = 0; i < e.length; i++) if (e[i] === t) return void e.splice(i, 1);
            ...
            u = (function () {
                function e() {
                    !(function (e, t) {
                        ...
                        (this.step = 1),
                        (this.type = "single"),
                        (this.typeConstants = { singleValue: "single", rangeValue: "range" }),
                        this._addEvents();
                }
                var t, i, n;
                return (
                    ...
                    (i = [
                        ...
                        },
                        {
                            ...
                            value: function (e, t, i) {
                                ...
                                n < this.minLimit
                                    ? ((this[t] = this.minLimit), i || console.log("The value was equated to the minimum, because it is less than the minimum value."))
                                    : n > this.maxLimit
                                    ? ((this[t] = this.maxLimit), i || console.log("The value was equated to the maximum, because it is more than the maximum value."))
                                    : (this[t] = n);
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                for (var t in this.typeConstants)
                                    if (e === this.typeConstants[t])
                                        return (
                                            (this.type = e),
                                            this.typeUpdateEvent.trigger({ value: this.type, typeConstants: Object.assign({}, this.typeConstants) }),
                                            { value: this.type, typeConstants: Object.assign({}, this.typeConstants) }
                                        );
                            },
                        },
                        {
                            ...
                            value: function (e, t) {
                                ...
                                return (
                                    ...
                                    i === n && ((this.minLimit = i), (this.maxLimit = n + 1), t || console.log("Maximum limit was increased by 1, because the minimum limit is equal to the maximum limit.")),
                                    i > n && ((this.minLimit = n), (this.maxLimit = i), t || console.log("Limits was reversed, because the maximum limit is less than the minimum limit.")),
                                    (this.valuesCount = this.maxLimit - this.minLimit),
                                    this.limitsUpdateEvent.trigger({ minLimit: this.minLimit, maxLimit: this.maxLimit, valuesCount: this.valuesCount }),
                                    { minLimit: this.minLimit, maxLimit: this.maxLimit, valuesCount: this.valuesCount }
                                );
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                return (
                                    ...
                                    (this.singleSelected = ((this.singleValue - this.minLimit) / this.valuesCount) * 100),
                                    this.valueUpdateEvent.trigger({ value: this.singleValue, selected: this.singleSelected }),
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                ...
                                return (
                                    ...
                                    (this.rangeSelected = ((this.rangeValueMax - this.rangeValueMin) / this.valuesCount) * 100),
                                    this.valueUpdateEvent.trigger({ minValue: this.rangeValueMin, maxValue: this.rangeValueMax, selected: this.rangeSelected }),
                                    { minValue: this.rangeValueMin, maxValue: this.rangeValueMax, selected: this.rangeSelected }
                                );
                            },
                        },
                        {
                            ...
                            value: function (e, t, i) {
                                if (o.isNumber(e))
                                    return (
                                        (e = !1 === t ? Math.round(+e) : Math.round((this.valuesCount * +e) / 100 + this.minLimit)),
                        ...
                        },
                        {
                            key: "getType",
                            value: function () {
                                return { value: this.type, typeConstants: Object.assign({}, this.typeConstants) };
                            },
                        },
                        {
                            key: "getLimits",
                            value: function () {
                                return { minLimit: this.minLimit, maxLimit: this.maxLimit, valuesCount: this.valuesCount };
                            },
                        },
                        {
                            key: "getStep",
            ...
            v = (function () {
                function e() {
                    !(function (e, t) {
                        ...
                        (this.theme = { value: "default", className: "theme", oldValue: null }),
                        (this.direction = { value: "horizontal", className: "direction", oldValue: null }),
                        (this.directionConstants = { horizontalValue: "horizontal", verticalValue: "vertical" }),
                    ...
                    (i = [
                        {
                            ...
                            value: function (e) {
                                e.value === e.typeConstants.singleValue &&
                                    (this.$handleMin.detach(), this.$handleMax.detach(), this.$valueNoteMin.detach(), this.$valueNoteMax.detach(), this.$handle.appendTo(this.$path), this.$valueNote.appendTo(this.$outer)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                [this.$base, this.$outer, this.$path, this.$pathPassed, this.$divisions, this.$handle, this.$handleMin, this.$handleMax, this.$valueNote, this.$valueNoteMin, this.$valueNoteMax]
                        ...
                        },
                        {
                            ...
                            value: function (e, t, i) {
                                var n,
                                    ...
                                    h = i.typeConstants;
                                if (
                                    ([this.$pathPassed, this.$handle, this.$handleMin, this.$handleMax, this.$valueNote, this.$valueNoteMin, this.$valueNoteMax].forEach(function (e) {
                                        e.attr("style", "");
                                    }),
                                    u === h.singleValue &&
                                        (this.$valueNote.text(e.value),
                                        o === l.horizontalValue &&
                                            (this.$pathPassed.css("width", a + "%"),
                                            this.$handle.css("left", a + "%"),
                                            (n = this.$path.outerWidth()),
                                            (s = this.$valueNote.outerWidth()),
                                            this.$valueNote.css("left", (((n * a) / 100 - s / 2) / n) * 100 + "%")),
                                        o === l.verticalValue &&
                                            (this.$pathPassed.css("height", a + "%"),
                                            this.$handle.css("top", 100 - a + "%"),
                                            (n = this.$path.outerHeight()),
                                            (s = this.$valueNote.outerHeight()),
                                            this.$valueNote.css("top", 100 - (((n * a) / 100 + s / 2) / n) * 100 + "%"))),
                                    u === h.rangeValue)
                                ) {
                                    var r,
                                        d,
                                        v = ((e.minValue - t.minLimit) / t.valuesCount) * 100;
                                    this.$valueNoteMin.text(e.minValue),
                                        this.$valueNoteMax.text(e.maxValue),
                                        o === l.horizontalValue &&
                                            (this.$pathPassed.css("width", a + "%"),
                                            this.$pathPassed.css("left", v + "%"),
                                            this.$handleMin.css("left", v + "%"),
                                            this.$handleMax.css("left", v + a + "%"),
                                            (n = this.$path.outerWidth()),
                                            (r = this.$valueNoteMin.outerWidth()),
                                            (d = this.$valueNoteMax.outerWidth()),
                                            this.$valueNoteMin.css("left", (((n * v) / 100 - r / 2) / n) * 100 + "%"),
                                            this.$valueNoteMax.css("left", (((n * (v + a)) / 100 - d / 2) / n) * 100 + "%")),
                                        o === l.verticalValue &&
                                            (this.$pathPassed.css("height", a + "%"),
                                            this.$pathPassed.css("top", 100 - a - v + "%"),
                                            this.$handleMax.css("top", 100 - v - a + "%"),
                                            this.$handleMin.css("top", 100 - v + "%"),
                                            (n = this.$path.outerHeight()),
                                            (r = this.$valueNoteMin.outerHeight()),
                                            (d = this.$valueNoteMax.outerHeight()),
                                            this.$valueNoteMin.css("top", 100 - (((n * v) / 100 + r / 2) / n) * 100 + "%"),
                                            this.$valueNoteMax.css("top", 100 - (((n * (v + a)) / 100 + d / 2) / n) * 100 + "%"));
                                }
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                if (d.isNumber(e) && !(e < 0))
                                    return (
                                        1 == (e = Math.round(+e)) && (e++, t || console.log("Count was increased by one, cause it may not be equal to one.")),
                                    ...
                                    for (var t in this.directionConstants)
                                        if (e === this.directionConstants[t])
                                            return (
                                                ...
                                                this.directionUpdateEvent.trigger({ value: this.direction.value, constants: Object.assign({}, this.directionConstants) }),
                                                { value: this.direction.value, constants: Object.assign({}, this.directionConstants) }
                                            );
                            },
                        },
                        {
                        ...
                        },
                        {
                            key: "getDirection",
                            value: function () {
                                return { value: this.direction.value, constants: Object.assign({}, this.directionConstants) };
                            },
                        },
                        {
                        ...
                        },
                        {
                            key: "_addEvents",
                            value: function () {
                                (this.UIMouseActionEvent = r()),
                                    (this.rootsUpdateEvent = r()),
                                    (this.themeUpdateEvent = r()),
                                    (this.directionUpdateEvent = r()),
                                    (this.valueNoteDisplayUpdateEvent = r()),
                                    (this.divisionsCountUpdateEvent = r());
                            },
                        },
                        {
                            key: "_addListenners",
                                ...
                                if (0 === e.button) {
                                    var t = !1,
                                        i = function (e) {
                                            ...
                                            a === o.horizontalValue && ((t = this.$path.outerWidth()), (i = this.$path[0].getBoundingClientRect().left), (s = e.clientX)),
                                                a === o.verticalValue && ((t = this.$path.outerHeight()), (i = this.$path[0].getBoundingClientRect().top), (s = e.clientY)),
                                                (n = i + t),
                                                s < i - 10 ||
                                                    s > n + 10 ||
                                                    (a === o.horizontalValue && this.UIMouseActionEvent.trigger(((s - i) / t) * 100), a === o.verticalValue && this.UIMouseActionEvent.trigger(100 - ((s - i) / t) * 100));
                                        }.bind(this),
                                        n = function (e) {
                                            var n = $(e.target);
                                    ...
                                    $(document.body).one("mousemove", function () {
                                        ...
                                        $(document.body).on("mousemove.moveAction", i),
                                        $(document.body).one("mouseup", n);
                                }
                            },
                        },
                    ]) && h(t.prototype, i),
            ...
            return (
                ...
                (i = [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            void 0 !== (e = e || {}).onTypeUpdate && this.onTypeUpdate(e.onTypeUpdate),
                                void 0 !== e.onLimitsUpdate && this.onLimitsUpdate(e.onLimitsUpdate),
                                void 0 !== e.onStepUpdate && this.onStepUpdate(e.onStepUpdate),
                                void 0 !== e.onValueUpdate && this.onValueUpdate(e.onValueUpdate),
                                void 0 !== e.onRootsUpdate && this.onRootsUpdate(e.onRootsUpdate),
                                void 0 !== e.onThemeUpdate && this.onThemeUpdate(e.onThemeUpdate),
                                void 0 !== e.onDirectionUpdate && this.onDirectionUpdate(e.onDirectionUpdate),
                                void 0 !== e.onDivisionsCountUpdate && this.onDivisionsCountUpdate(e.onDivisionsCountUpdate),
                                void 0 !== e.onValueNoteDisplayUpdate && this.onValueNoteDisplayUpdate(e.onValueNoteDisplayUpdate);
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            (e = e || {}),
                                this.view.setRoots(e.$roots),
                                void 0 !== e.type && this.model.setType(e.type),
                                void 0 !== e.limits && this.model.setLimits(e.limits),
                                void 0 !== e.step && this.model.setStep(e.step),
                                void 0 !== e.singleValue && this.model.setSingleValue(e.singleValue),
                                void 0 !== e.rangeValue && this.model.setRangeValue(e.rangeValue),
                                void 0 !== e.divisionsCount && this.view.setDivisionsCount(e.divisionsCount),
                                void 0 !== e.theme && this.view.setTheme(e.theme),
                                void 0 !== e.direction && this.view.setDirection(e.direction),
                                void 0 !== e.valueNoteDisplay && this.view.setValueNoteDisplay(e.valueNoteDisplay);
                        },
                    },
                    {
                        key: "_triggerEvents",
