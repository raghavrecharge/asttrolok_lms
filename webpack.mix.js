...
// .babel('resources/js/parts/upcoming_course_show.js', 'public/assets/default/js/parts/upcoming_course_show.min.js')
...
// .babel('resources/js/admin/create_upcoming_course.js', 'public/assets/admin/js/create_upcoming_course.min.js')
...
// .babel('resources/js/admin/settings/general.js', 'public/assets/default/js/admin/settings/general.min.js')
// .babel('resources/js/admin/settings/others_personalization.js', 'public/assets/default/js/admin/settings/others_personalization.min.js')
