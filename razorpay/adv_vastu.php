...
<input type="hidden" name="merchant_order_id" id="merchant_order_id" value="advancevastu"> 
...
<input type="hidden" name="furl" id="furl" value="https://www.asttrolok.com/razorpay/failed.php"> 
       ...
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
        ...
        <input type="number"  id="amount" class="require" name="amount" placeholder="amount" value="8850" required disabled>
      </div>
...
<script type="text/javascript">
  jQuery(document).on('click', '#razor-pay-now', function (e) {
    ...
    var store_description = 'Advance Vastu Course Payment';
