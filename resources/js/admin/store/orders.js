(function () {
    ...
    function makeEnterTrackingCodeModalHtml(order, saleId) {
        return `
            <div>
                ...
                <form action="${adminPanelPrefix}/store/orders/${saleId}/productOrder/${order.id}/setTrackingCode" method="post">
    ...
    $('body').on('click', '.js-enter-tracking-code', function () {
        ...
        const path = `${adminPanelPrefix}/store/orders/${saleId}/getProductOrder/${orderId}`;
