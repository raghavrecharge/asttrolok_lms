(function () {
    ...
    $('body').on('click', '#addNewUserToNotaccess', function (e) {
        e.preventDefault();

        let html = '<div id="addUserToNotAccessModalSwl">';
        html += $('#addUserToNotAccessModal').html();
        html += '</div>';
    ...
    $('body').on('click', '.js-save-add-user-to-not-access', function (e) {
        e.preventDefault();
