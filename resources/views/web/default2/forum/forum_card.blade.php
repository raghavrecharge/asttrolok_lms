    ...
    <div class="col-12 col-md-6">
        <div class="d-flex align-items-center">
            <div class="forums-categories-card__icon p-5">
                <img src="{{ config('app.img_dynamic_url') }}{{ $forum->icon }}" alt="{{ $forum->title }}" class="img-cover">
            </div>
            <div class="ml-10">
    ...
    <div class="col-8 col-md-4 mt-10 mt-md-0 forums-categories-card__last-post d-flex align-items-center">
        @if(!empty($forum->lastTopic))
            <div class="user-avatar rounded-circle">
                <img src="{{ config('app.img_dynamic_url') }}{{ $forum->lastTopic->creator->getAvatar(39) }}" class="img-cover rounded-circle" alt="{{ $forum->lastTopic->creator->full_name }}">
            </div>
