            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/forum/1.svg" alt="{{ trans('update.forums') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/forum/2.svg" alt="{{ trans('update.topics') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/forum/3.svg" alt="{{ trans('site.posts') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/forum/4.svg" alt="{{ trans('update.members') }}" class="forum-stat-icon"/>
            ...
            @foreach($featuredTopics as $featuredTopic)
                <div class="forums-featured-card d-flex align-items-center bg-white p-20 p-md-35 rounded-lg mt-15">
                    <div class="forums-featured-card-icon">
                        <img src="{{ config('app.img_dynamic_url') }}{{ $featuredTopic->icon }}" alt="{{ $featuredTopic->topic->title }}" class="img-cover">
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-15">
                        <div class="forum-recommended-topics__card position-relative rounded-lg bg-white px-20 py-30">
                            <div class="forum-recommended-topics__icon">
                                <img src="{{ config('app.img_dynamic_url') }}{{ $recommendedTopic->icon }}" alt="{{ $recommendedTopic->title }}" class="img-cover">
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-5 d-none d-md-block position-relative">
                <div class="forum-question-section__img">
                    <img src="{{ config('app.js_css_url') }}/assets/default/img/forum/question-section.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
