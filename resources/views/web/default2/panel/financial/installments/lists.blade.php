            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/129.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/130.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/127.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/128.png" width="64" height="64" alt="">
                            ...
                            <div class="webinar-card webinar-list panel-installment-card d-flex">
                                <div class="image-box" style="height:auto !important;">
                                    ...
                                    @elseif($itemType == 'product')
                                        <img src="{{ config('app.img_dynamic_url') }}{{ $orderItem->thumbnail }}" class="img-cover" alt="">
                                    @elseif($itemType == "subscribe")
                                        <div class="d-flex align-items-center justify-content-center w-100 h-100">
                                            <img src="{{ config('app.img_dynamic_url') }}{{ config('app.js_css_url') }}/assets/default/img/icons/installment/subscribe_default.svg" alt="">
                                        </div>
                                    @elseif($itemType == "registrationPackage")
                                        <div class="d-flex align-items-center justify-content-center w-100 h-100">
                                            <img src="{{ config('app.img_dynamic_url') }}{{ config('app.js_css_url') }}/assets/default/img/icons/installment/reg_package_default.svg" alt="">
                                        </div>
                                    @endif
