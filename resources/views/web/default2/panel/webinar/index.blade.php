    ...
    <section>
        ...
        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/hours.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/download-sales.svg" width="64" height="64" alt="">
                ...
                <div class="row mt-30">
                    <div class="col-12">
                        <div class="webinar-card webinar-list d-flex">
                            <div class="image-box">
                                <img src="{{ config('app.img_dynamic_url') }}{{ $webinar->getImage() }}" class="img-cover" alt="">
...
@push('scripts_bottom')
    ...
    <script src="{{ config('app.js_css_url') }}/assets/default/js/panel/make_next_session.min.js"></script>
@endpush
