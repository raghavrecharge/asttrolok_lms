            ...
            <div class="row">
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/56.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/57.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center mt-5 mt-lg-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/60.svg" width="64" height="64" alt="">
...
@push('scripts_bottom')
    ...
    <script src="{{ config('app.js_css_url') }}/assets/default/js/panel/certificates.min.js"></script>
@endpush
