...
@section('content')
    ...
    <div class="create-webinar-footer d-flex align-items-center justify-content-between mt-20 pt-15 border-top row">
...
@push('scripts_bottom')
    <script src="{{ config('app.js_css_url') }}/assets/vendors/cropit/jquery.cropit.js"></script>
    <script src="{{ config('app.js_css_url') }}/assets/default/js/parts/img_cropit.min.js"></script>
    ...
    <script src="{{ config('app.js_css_url') }}/assets/default/js/panel/user_setting.min.js"></script>
@endpush
