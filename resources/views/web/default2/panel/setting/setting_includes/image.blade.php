    ...
    <div class="row mt-20">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group">
                ...
                <img src="{{ config('app.img_dynamic_url') }}{{ (!empty($user)) ? $user->getAvatar(150) : '' }}" alt="" id="profileImagePreview" width="150" height="150" class="rounded-circle my-15 d-block ml-5">
        ...
        <div class="col-12 col-lg-4">
            <div class="form-group">
                ...
                <img src="{{ config('app.img_dynamic_url') }}{{ (!empty($user)) ? $user->getCover() : '' }}" alt="" id="profileCoverPreview" height="150" class="rounded-sm my-15 d-block w-100">
