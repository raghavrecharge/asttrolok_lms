...
<head>
    ...
    <link rel="stylesheet" href="{{ config('app.js_css_url') }}/assets2/default/css/panel.css">
...
<script src="{{ config('app.js_css_url') }}/assets2/default/js/panel/public.min.js"></script>
