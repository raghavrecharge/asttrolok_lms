            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/physical_product3.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/physical_product2.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/physical_product1.png" width="64" height="64" alt="">
                                        ...
                                        <td class="text-left">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar bg-gray200">
                                                    <img src="{{ config('app.img_dynamic_url') }}{{ !empty($order->seller) ? $order->seller->getAvatar() : '' }}" class="img-cover" alt="">
                                                </div>
                                                <div class=" ml-5">
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu font-weight-normal">
                                                        ...
                                                        @if($order->status == \App\Models\ProductOrder::$shipped)
                                                            ...
                                                            <button type="button" data-sale-id="{{ $order->sale_id }}" data-product-order-id="{{ $order->id }}" class="js-got-the-parcel webinar-actions btn-transparent d-block mt-10"></button>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endif
