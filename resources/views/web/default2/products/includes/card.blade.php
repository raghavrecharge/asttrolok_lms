    ...
    <figure>
        <div class="image-box">
            <a href="{{ $product->getUrl() }}" class="image-box__a">
                ...
                <img src="{{ config('app.img_dynamic_url') }}{{ $product->thumbnail }}" class="img-cover" alt="{{ $product->title }}">
            </a>
        ...
        <figcaption class="product-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img src="{{ config('app.img_dynamic_url') }}{{ $product->creator->getAvatar() }}" class="img-cover" alt="{{ $product->creator->full_name }}">
                </div>
