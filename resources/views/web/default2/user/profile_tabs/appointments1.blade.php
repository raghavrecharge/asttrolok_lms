...
<div id="slotsTime" class="d-flex flex-wrap align-items-center mt-25" style="justify-content: center !important;">
    ...
    @if($selected == '30' )
        <div class=" d-none position-relative available-times1 text-center rounded-lg font-14 text-gray border date-active" style="justify-content: center !important;">
            <input type="radio" name="time1" id="slotTime30" value="30" data-type="online" {{ $selectedTime == '30' ? 'checked' : '' }} style="visibility: hidden;display: none;">
    ...
    @endif
     ...
     @if($selected == '15' )
        <div class="position-relative available-times1 ml-20 text-center rounded-lg font-14 text-gray border d-none">
            <input type="radio" name="time1" id="slotTime15" value="15" data-type="online" {{ $selectedTime == '15' ? 'checked' : '' }} style="visibility: hidden;display: none;">
            <label for="slotTime15" class="mt-10 mx-20 font-weight-bold ">15 Min</label>
        </div>
    @endif
</div>
    ...
    <div class="pick-a-time d-none" id="PickTimeContainer" data-user-id="{{ $user["id"] }}">
        ...
        <form action="{{ route('bundle.consultation.book') }}" method="post" id="PickTimeBody" class="d-none">
            <input type="hidden" name="bundle_id" value="{{ $bundle_id }}">
<input type="hidden" name="bundle_webinar_id" value="{{ $bundle_webinar_id }}">
