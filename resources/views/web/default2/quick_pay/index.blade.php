                    ...
                    <div class="schedule-preview">
                        ...
                        <div class="row text-center mb-10">
                            <div class="col-4">
                                ...
                                <div class="font-16 font-weight-bold">{{ handlePrice($remaining) }}</div>
                            </div>
                            <div class="col-4">
                                <div class="font-12 text-gray">Installments</div>
                                <div class="font-16 font-weight-bold">{{ count($installmentBreakdown) }}</div>
                            </div>
                            <div class="col-4">
                                <div class="font-12 text-gray">Upfront</div>
                                <div class="font-16 font-weight-bold text-primary">{{ handlePrice($installmentBreakdown[0]['amount']) }}</div>
                            </div>
                        </div>
                        ...
                        @foreach($installmentBreakdown as $idx => $item)
                            <div class="schedule-row">
                                ...
                                <span class="unpaid">
                                    @if($item['deadline_days'] === 0)
                                        Due now
                                    @else
                                        Due in {{ $item['deadline_days'] }} days
                                    @endif
                                </span>
                            </div>
                        @endforeach
