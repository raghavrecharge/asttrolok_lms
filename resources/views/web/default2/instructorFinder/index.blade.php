...
@push('scripts_bottom')
    ...
    <script src="{{ config('app.js_css_url') }}/assets/vendors/leaflet/leaflet.markercluster/leaflet.markercluster-src.js"></script>
    ...
    <script src="{{ config('app.js_css_url') }}/assets/default/js/parts/instructor-finder-wizard.min.js"></script>
    <script src="{{ config('app.js_css_url') }}/assets/default/js/parts/instructors.min.js"></script>

    <script src="{{ config('app.js_css_url') }}/assets/default/js/parts/instructor-finder.min.js"></script>
@endpush
