        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <select id="state" name="province_id" class="form-control @error('province_id') is-invalid @enderror" disabled>
                ...
                <div class="form-group">
                    ...
                    <select id="city" name="city_id" class="form-control @error('city_id') is-invalid @enderror" disabled>
                 ...
                 <div class="form-group">
                    <label class="input-label font-weight-500">{{ trans('update.pin_code') }}</label>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="form-group">
                <label for="message" class="input-label font-weight-500">
...
function findByName(array, name) {
    if (!Array.isArray(array)) return null;
    return array.find(item => parseInt(item.name) === parseInt(name));
}
...
// let selectedCountry = 'Algeria';
// let selectedCountry = @json(session()->get('country', ''));
...
if(selectedCountry){
    ...
    $.each(countriesData, function(index, country) {
        ...
        let selected = (selectedCountry == country.name) ? 'selected' : '';
        $('#country').append('<option value="' + country.id + '" ' + selected + '>' + country.name + '</option>');
    });
    
    // var countryId = $(this).val();
        // var country = selectedCountry;
        var country = findByName(countriesData, country);
    ...
    function handleNonIndiaCountry(country) {
        ...
        console.log("Function Triggered! Country:", country.name);
        ...
        console.log("delivery fee for international:", country.name);
        
        sessionStorage.setItem("cty", country.name)
        ...
        // if (sessionStorage.getItem("cty")) {
            fetch("{{ route('set.session') }}", { 
                ...
                body: JSON.stringify({
                    ...
                    country: sessionStorage.getItem("cty")
                })
            })
            .then(res => res.json())
            .then(data => {
