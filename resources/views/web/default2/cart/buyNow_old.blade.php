    ...
    function addscript(){
        ...
        if(name ===''){
         ...
         if(mobile ===''){
          ...
          var   dataamount="<?php echo (int)(preg_replace('/[^\d.]/', '', handlePrice($total * 100))); ?>";
        //var   databuttontext="product_price";
          var   datadescription="Payment for the course {{ $webinar->title }} was successfully made via Razorpay throughour official website – Asttrolok, using a desktop(buynow)";
