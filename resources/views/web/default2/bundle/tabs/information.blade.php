...
@if(!empty($installments) and count($installments) and getInstallmentsSettings('installment_plans_position') == 'top_of_page')
    @foreach($installments as $installmentRow)
        @include('web.default2.installment.card',['installment' => $installmentRow, 'itemPrice' => $bundle->getPrice(), 'itemId' => $bundle->id, 'itemType' => 'course'])
    @endforeach
@endif
...
@if($bundle->description)
    <div class="mt-20">
        <h2 class="section-title after-line">About this bundle</h2>
    ...
    <div class="mt-30">
        ...
        <div class="forums-featured-card d-flex align-items-center bg-white p-20 p-md-35 shadow-lg rounded-lg mt-15">
            <div class="forums-featured-card-icon" style="width: 250px; min-width: 250px; ">
                <img src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/faqs/Alok-sir1.png" alt="What is social media?" class="img-cover">
            </div>

            <div class="ml-50">
                <h4 class="font-20 font-weight-bold text-dark">Mr. Alok Khandelwal</h4><br>
                <p class="font-16 text-gray">Mr. Alok Khandelwal is not only recognized for his exceptional astrological expertise but also for his global impact. He extends his teachings beyond borders, making Vedic Knowledge reach students in countries like Russia with the help of professional translators.</p><br>
                <p class="font-16 text-gray">Moreover, Mr. Khandelwal's passion for sharing knowledge takes him to various countries where he engages in public speaking, teaching, and consultation, and delivers introductory talks on Vedic science with a project called Unwinding.</p><br>
                <p class="font-16 text-gray">With over 35,000 students already taught and hundreds more added each year, Mr. Khandelwal's impact continues to grow. He is highly regarded for his expertise in Ancient Vedic Astrology and interpersonal skills, offering practical solutions to professional, personal, emotional, and mental challenges. Additionally, he holds membership in the esteemed 'Art of Living' foundation and is sought-after as a guest speaker in prestigious institutions nationwide.</p>
            </div>
        </div>
    </div>
    @endif
