    ...
    <div class="container">
        <div class="row login-container1">
            <div class="col-12 col-md-6 pl-0"  style="display: flex;flex-wrap: nowrap;align-items: center;">
                <img src="{{ config('app.img_dynamic_url') }}/store/1/default_images/01.jpg"  style="height:auto;" class="img-cover" alt="Login">
            </div>
                       ...
                       <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input name="password" type="password" maxlength="40" class="form-control @error('password') is-invalid @enderror" id="password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input name="password_confirmation" type="password" maxlength="40" class="form-control @error('password_confirmation') is-invalid @enderror" id="confirm_password">
                                <div class="input-group-append">
