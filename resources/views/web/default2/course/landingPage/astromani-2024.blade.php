        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-4">
                    <h1 id='title'>India's Most Awaited Course - Astromani</h1><h2 style="color: #43d276 !important;text-transform: uppercase;font-weight: 900;font-size: x-large;"><strong>Starting from 21st July</strong></h2>
                    ...
                    <div class="cls">
                        ...
                        <a  href="/course/astromani-2024" class="btn-get-started scrollto" style="cursor: pointer;">Enroll Now<img  class="btn_arrow" id="register-arrow" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/btn-arrow.png" alt="Arrow" width="20px" height="14px" style="margin-top: 0px; display: none;" /></a>
...
<div  class="grid gtc-lg-5 gtc-md-2 gtc gtc-sm-1 date_time_block px-20" style="z-index: 20; position:relative;background: #f3f3f3;font-family: 'Poppins', Sans-serif !important;">
                            ...
                            <div class="item date_time">
                                ...
                                <div class="fulldate" >7-9 PM IST</div>
                            </div>
                        </div>
                        ...
                        <div class="white_block white_block_transparent count_block_whiteblock">
                            ...
                            <div class="include_details">
                                <div>
                                    ...
                                    <img   src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/250-Additional-Videos-min.png" alt="250 Additional Videos - Asttrolok">
                                    <div class="include_details_bg">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Signs and their characteristics, gender of signs, ownership & their letters
                                                </li>
                                                <li>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Prediction about all Bhavas</li>
<li>Bhavat Bhavam</li>
...
<li>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Dhan Yoga, Raj Yoga, Panch Mahapurush Yoga, Gajkesari Yoga
                                                </li>
                                                <li>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Analysis of Vimshottari Dasha, Mahadasha, Antardasha, Pratyantar Dasha and
                                                </li>
                                                <li>
                                                    Sukshma Dasha
                                                </li>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingSix">
										...
										Secrets of Navmansha & D Charts</button>
                                    </h2>
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Navmasha - How it is created, Basic Properties in Navamsa
                                                </li>
                                                <li>
                           ...
                           <center> <h3 class="brown_heading py-3">FAQs
                            ...
                            <div class="accordion" id="accordionExample1">
                                        ...
                                        <div class="highlight_review text-center mt-0">
                                            ...
                                            <div class="review_detail show-read-more1">
                                                We provide classes once a week, and that will be on the weekend on Friday to Saturday from 7-9 PM IST.
...
<div id="validation">
            ...
            <form action="/contact/course"  id="formVal12345" method="post" class="mt-20 formVal12345">
                {{ csrf_field() }}
  <input type="hidden" name="subject" id="subject" maxlength="100" value="Astromani-2024"/>
                <div class="row">
...
<div class="specialist-info1 queries  queries-info1" style="text-align:center;">
                    ...
                    <div class="right_block_container">
                        <div class="right_block register_desktop mt-5" style="">
                            <h3>India's Most Awaited Course - Astromani</h3>
                            <span class="date-and-time"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/date.png" alt="Date" width="100" height="100" />1 Live Class Per Week (Saturday)</span>
                            ...
                            <a  id="myBtn2" href="/course/astromani-2024"  style="cursor: pointer;" class="btn-get-started scrollto right_register" >Buy Now
...
<a  id="myBtn31" href="/course/astromani-2024" style="cursor: pointer;"  class="btn-get-started scrollto right_register">Register</a>
</div>
