    ...
    <div class="container">
        ...
        <div class="row login-container1">
            ...
            <div class="col-12 col-md-6 pl-0" style="display: flex;flex-wrap: nowrap;align-items: center;">
                <div >
                <img src="{{ config('app.img_dynamic_url') }}/store/1/default_images/01.jpg" class="img-cover" style="height:auto;" alt="Login">
                </div>
            </div>
...
<input name="slug" type="hidden" id="slug" value="learn-free-astrology-course-english" >
                    ...
                    <div class="mt-20 text-center">
                        ...
                        <a href="/register-free" class="text-secondary font-weight-bold">{{ trans('auth.signup') }}</a>
                    </div>
                </div>
            </div>
        </div>
