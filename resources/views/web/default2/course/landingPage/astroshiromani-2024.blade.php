        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-4">
                    <h1 id='title'>Astro Shiromani: The Ultimate Astrology Course</h1><h2 style="color: #43d276 !important;text-transform: uppercase;font-weight: 900;font-size: x-large;"><strong>Starting from 12 Aug 2024</strong></h2>
                    ...
                    <div class="cls">
                        ...
                        <a  href="/course/astroshiromani-2024" class="btn-get-started scrollto" style="cursor: pointer;">Enroll Now<img  class="btn_arrow" id="register-arrow" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/btn-arrow.png" alt="Arrow" width="20px" height="14px" style="margin-top: 0px; display: none;" /></a>
                   <!--<button id="myBtn" class="btn-get-started scrollto">Register Now<img  class="btn_arrow" id="register-arrow" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/btn-arrow.png" alt="Arrow" width="20px" height="14px" style="margin-top: 0px; display: none;" /></button>-->
                    ...
                    </div><br><span style="font-family: 'Poppins', Sans-serif !important;"><b>200+</b> people have already joined</span> <br><br>
...
<div  class="grid gtc-lg-5 gtc-md-2 gtc gtc-sm-1 date_time_block px-20" style="z-index: 20; position:relative;background: #f3f3f3;font-family: 'Poppins', Sans-serif !important;">
                            ...
                            <div class="item date_time">
                                ...
                                <div class="fulldate">Per Week</div>
                            </div>
                             <div class="item date_time">
                                ...
                                <div class="stdate">Recorded Video</div>
                            ...
                            <div class="item date_time duaration_time">
                                ...
                                <div class="fulldate">8 Months</div>
                            </div>
                            <div class="item date_time">
                                ...
                                <div class="fulldate" >7:30-9:30 PM IST</div>
                            </div>
                        </div>
                            ...
                            <div class="include_details">
                             ...
                             <div class="include_details">
                                <div>
                                    ...
                                    <img    src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/Class-Recordings-min.png" alt="Class Recordings - Asttrolok">
                                    <div class="include_details_bg">
                                        <h4>Class Recordings</h4>
                                        <div class="include_text">Never miss a class with access to recorded sessions for convenient learning at your own pace.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="include_details">
                                <div>
                                    ...
                                    <img   src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/Additional-Videos-min.png" alt="250 Additional Videos - Asttrolok">
                                    <div class="include_details_bg">
                                        <h4>Additional Videos</h4>
                                        <div class="include_text">Enhance your knowledge with additional videos covering various astrological concepts.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="include_details">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <!--<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">-->
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Detailed analysis of Dashmansha, Chaturthamansha, saptmasha, Dreskana(D3), Hora(D2), and other Varga charts

                                                </li>
                                                <li>
                                                    Other dashas:<br>
                                                    1) Other dasha in Astrology <br>2) Ashtottari, Shodashottari,
                                                </li>
                                                <li>
                                                    Dwisaptti sama dasha, Dwadashottari, Panchottari,
                                                </li>
                                                <li>
                                                    Shataabdika, Chaturshiti sama dasha, Shashti Hayni, Shat Trimash sama dasha.
                                                </li>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Selection of Education through horoscope, Art, commerce, science, maths, business management,
MBBS etc, fashion designing, Engineering and other education streams </li>
<!--<li>Bhavat Bhavam</li>-->
<!--<li>Characteristics of different Ascendants,</li>-->
<!--<li>Benefic and Malefic Planets of different Ascendants</li>-->
<!--<li>Directions of different Planets</li>-->
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Analysis of diseases through horoscope, Arishta, Balrishta, Arishtabhanga, Accidents, concept of
medical astrology, Body parts according to rashis and bhava, malefic and benefic planets, specific
illness, mental illness, diabetes, eye diseases, mouth diseases, heart problems, stomach problems
and analysis of other diseases. 
                                                </li>
                                                <li>
                                                    Arudha Lagna: Importance of Arudha lagna, houses from arudha, planet from arudha, judgement of
native’s progress and success of arudha, public image from arudha lagna
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Detailed analysis of matchmaking, divorce, multiple relations, gay and lesbian relationship, multiple
marriages, Marriage and tithi relationship, Relations with father, mother, brother, sister, in-laws, life
partner, children, boss etc. 
                                                ...
                                                <!--</li>-->
                                                <!--<li>Double Transit theory of Saturn & Jupiter</li>-->
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Two, three, four, five, six planet conjunction in Vedic astrology. Important principle and predictions
through conjunction. 
                                                </li>
                                                <!--<li>-->
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingEight">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
											Astakvarga Technique</button>
                                    </h2>
                                    <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Concept of astakvarga, bhinnashtakvarga, trikonshodhan, ekadhipatyashodhanetc, prediction
through astakvarga. 
                                                </li>
<!--                                                <li>-->
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            ...
                                            <ul>
                                                <li>
                                                    Casting of prashna chart, basic rules of prashna, Prediction through prashna kundli with the help of
parashari technique
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseseven" class="accordion-collapse collapse" aria-labelledby="headingseven" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    27 Nakstra and their mythological stories, nakshtra devatas, prediction through navtara
chakra, muhuratas
...
Krishnamurthi Technique
                                    ...
                                    <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Principles of KP, 27 Nakshatra and their lord, analysis of nakshatra lord, sub lord and sub sub lord,
prashna kundli of KP, ruling planets, prediction through KP
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
Predictions Method and Techniques
</button>
                                    </h2>
                                    <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Assembling of various techniques for predictions, importance of Jupiter and Saturn in prediction,
general and specific methods of predictions, varshafala, shadbala, jail yoga, yoga for share market
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
Jaimini Astrology
                                    ...
                                    <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Basic rules of jaimini astrology, Details discussion of Atmakarka and Amatyakarka, important jaimini
sutras, rashi drishti
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
Remedial Astrology
                                    ...
                                    <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Remedy through gem therapy, Vedic remedies for different planets
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
Practical
                                    ...
                                    <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>
                                                    Practical for all the important topics will be conducted on regular basis. Research project will be
conducted for each student
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                           ...
                           <center> <h3 class="brown_heading py-3">FAQs
                            ...
                            <div class="accordion" id="accordionExample1">
                                        ...
                                        <div class="highlight_review text-center mt-0">
                                            ...
                                            <div class="review_detail show-read-more1">
                                                The entire online astrology course will be covered in 8 months, including assignments, practical, and exams. 
                                        <!--         <a class="show_hide" data-content="toggle-text">Read More</a>-->
                                        ...
                                        <div class="highlight_review text-center mt-0">
                                            <div class="review"><h4>What will be the class timings?</h4></div>
                                            
                                            <div class="review_detail show-read-more1">
                                                We provide classes once a week, and that will be on the weekend on Friday from 7:30-9:30 PM IST.
                                        <!--         <a class="show_hide" data-content="toggle-text">Read More</a>-->
                                        <!--        <div class="testinomial-content-more" id="more-data">awareness of Astrology principles. As a result, there is an increasing demand for professional and reliable experts in the domain and it would be a wise decision for anyone thinking of becoming a professional Astrologer.-->
                                        <!--</div>-->
                                            </div>
...
<div class="specialist-info1 queries  queries-info1" style="text-align:center;">
                    ...
                    <div class="right_block_container">
                        <div class="right_block register_desktop mt-5" style="">
                            <h3>Astro Shiromani: The Ultimate Astrology Course</h3>
                            <span class="date-and-time"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/date.png" alt="Date" width="100" height="100" />1 Live Class Per Week (Friday)</span>
                            <span class="date-and-time"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/time-blue.png" alt="Date" width="100" height="100" />8 Months</span>

                            <span class="date-and-time"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/rupee.png" alt="Date" width="100" height="100" />Rs: 64900/-</span>
                            <a  id="myBtn2" href="/course/astroshiromani-2024"  style="cursor: pointer;" class="btn-get-started scrollto right_register" >Buy Now
                            <!--<img  class="btn_arrow" id="right_register_arrow" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/btn-arrow.png" alt="Arrow" width="20px" height="14px" style="margin-top: 0px; display: none;" />-->
                            </a>
                             <span class="date-and-time gray"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/green-tick.png" alt="Date" width="100" height="100" />Course will be ONLINE on ZOOM</span>
                             <span class="date-and-time gray"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/green-tick.png" alt="Date" width="100" height="100" />Recorded Video</span>
                             <span class="date-and-time gray"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/green-tick.png" alt="Date" width="100" height="100" />Class Timings : 7:30-9:30 PM IST</span> 
                            <!-- <span class="date-and-time gray"><img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/green-tick.png" alt="Date" width="100" height="100" />Eat and sleep better</span> -->
                            <div class="people_joined_right">
                                <!-- <img  src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/group.png" alt="Date"> -->
                                <!-- <span>
...
<a  id="myBtn31" href="/course/astroshiromani-2024" style="cursor: pointer;"  class="btn-get-started scrollto right_register">Register</a>
</div>
