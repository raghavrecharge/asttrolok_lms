    ...
    <div class="assignment-top-stats d-flex flex-wrap flex-md-nowrap align-items-center justify-content-around">
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/calendar.svg" class="assignment-top-stats__icon" alt="">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/homework.svg" class="assignment-top-stats__icon" alt="">
                <strong class="font-20 text-dark-blue font-weight-bold mt-5">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/45.svg" class="assignment-top-stats__icon" alt="">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/58.svg" class="assignment-top-stats__icon" alt="">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ config('app.js_css_url') }}/assets/default/img/activity/88.svg" class="assignment-top-stats__icon" alt="">
                    ...
                    <div class="d-flex align-items-center justify-content-center flex-column bg-info-light p-10 rounded-sm border h-100">
                        <div class="learning-page-assignment-history-status-icon d-flex align-items-center justify-content-center">
                            @if($assignmentHistory->status == \App\Models\WebinarAssignmentHistory::$passed)
                                <img src="{{ config('app.js_css_url') }}/assets/default/img/learning/assignment_passed.svg" class="img-fluid" alt="">
                            @elseif($assignmentHistory->status == \App\Models\WebinarAssignmentHistory::$notPassed)
                                <img src="{{ config('app.js_css_url') }}/assets/default/img/learning/no_assignment.svg" class="img-fluid" alt="">
                            @else
                                <img src="{{ config('app.js_css_url') }}/assets/default/img/learning/assignment_pending.svg" class="img-fluid" alt="">
                            @endif
                        </div>
                            ...
                            <div class="assignment-attachments-post p-15 border rounded-sm mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="user-avatar rounded-circle">
                                        <img src="{{ config('app.img_dynamic_url') }}{{ $message->sender->getAvatar(50) }}" class="img-cover rounded-circle" alt="{{ $message->sender->full_name }}">
                                    </div>
                                    <div class="ml-10">
