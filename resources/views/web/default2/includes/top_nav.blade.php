...
<div class="top-navbar d-flex border-bottom top-navbarm" style="background-image: url('{{ config('app.img_dynamic_url') }}/store/1/Home/div.floating-bar.jpg')">
...
@push('scripts_bottom')
    ...
    <script defer src="{{ config('app.js_css_url') }}/assets/default/vendors/flagstrap/js/jquery.flagstrap.min.js"></script>
    <script defer src="{{ config('app.js_css_url') }}/assets/default/js/parts/top_nav_flags.min.js"></script>
@endpush
