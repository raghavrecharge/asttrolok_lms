...
.theme-header-1__top-navbar-search .search-icon i,
.theme-header-1__top-navbar-search .search-icon svg {
    color: #fff !important;
                    ...
                    @if(getOthersPersonalizationSettings('platform_phone_and_email_position') == 'header')
                        ...
                        @if(!empty($generalSettings['site_phone']))
                            <div class="d-flex align-items-center gap-6 opacity-75">
                                <a href="tel:{{ $generalSettings['site_phone'] }}" class="mail-icon" style="color:#fff; margin-right:10px;" target="_blank">
                                ...
                                <a href="tel:{{ $generalSettings['site_phone'] }}" class="mail-text" style="color:#fff; margin-right:10px;" target="_blank">
                                    <span class="text-white">{{ $generalSettings['site_phone'] }}</span>
                                </a>
                            </div>
                        @endif
                        ...
                        @if(!empty($generalSettings['site_email']))
                            {{--<div class="d-flex align-items-center gap-8 opacity-75 ml-0">
                                <a href="mailto:{{ $generalSettings['site_email'] }}" class="mail-icon" target="_blank">
                                    {{--<svg width="16px" height="16px" class="icons text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                ...
                                <a href="mailto:{{ $generalSettings['site_email'] }}" class="mail-text" target="_blank">
                                    <span class="text-white">{{ $generalSettings['site_email'] }}</span>
                                </a>
                            </div>--}}
                        @endif
                    @endif
