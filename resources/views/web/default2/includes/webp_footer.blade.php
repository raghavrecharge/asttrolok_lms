    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class=" col-md-5 mt-10">
                ...
                <a href="https://in.pinterest.com/asttrolok/"><img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/webp/store/1/default_images/social/social-icons/pinterest2.webp" alt="pinterest" class="mr-15"></a>
            </div>
        </div>
                            </div>
                        </div>
            ...
            <div class=" col-md-2 mt-10"> 
                ...
                <div class="align-items-center justify-content-between mt-15">
                    <div class="footer-social">
                        <a href="https://www.instagram.com/asttrolok"> <img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/webp/store/1/default_images/social/social-icons/Instagram1.webp" alt="Instagram" class="mr-15" /></a>
                        <a href="//api.whatsapp.com/send?phone=919174822333&text= "><img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}//webpstore/1/default_images/social/social-icons/Whatsapp1.webp" alt="Whatsapp" class="mr-15" /></a>
                        <a href="https://twitter.com/asttrolok"> <img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/webp/store/1/default_images/social/social-icons/Twitter1.webp" alt="Twitter" class="mr-15" /> </a>
                        <a href="https://www.facebook.com/asttrolok"><img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/webp/store/1/default_images/social/social-icons/FB1.webp" alt="Facebook" class="mr-15" /></a>
                        <!--<a href="https://www.youtube.com/@ASTTROLOKChannel"><img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/store/1/default_images/social/Youtube.webp" alt="youtube" class="mr-15" /></a>-->
                        <a href="https://in.pinterest.com/asttrolok/"><img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/webp/store/1/default_images/social/social-icons/pinterest2.webp" alt="pinterest" class="mr-15" /></a>
            ...
            <div class=" col-md-3 mt-10">
                ...
                <div class="mt-20 ">
                    ...
                    <p class="mt-5" style="font-size: 15px !important;">
                        <a href="https://maps.app.goo.gl/SogMK8SxiX9eHbRc9" target="_blank">
                            <font color="#ffffff" style="display: flex;justify-content: space-between;flex-direction: row;">
                                <img loading="lazy" decoding="async" src="{{ config('app.img_dynamic_url') }}/webp/store/1/default_images/social/Location Icon.svg" width="15" height="15" alt="Instagram" />
                                <span style="padding-left: 5px;"> 312, 3rd Floor, Vikram Urbane, 25-A Mechanic Nagar Extn. Sch# 54, Indore(MP) 452010 </span>
                            </font>
                        </a>
                    </p>
