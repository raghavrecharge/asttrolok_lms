           ...
           @foreach($subscription->faqs as $faq)
            <div class="accordion-row rounded-sm shadow-lg border mt-20 py-20 px-35">
                    <div class="font-weight-bold font-14 text-secondary" role="tab" id="faq_{{$count_faq}}">
                        <div href="#collapseFaq{{$count_faq}}" aria-controls="collapseFaq{{$count_faq}}" class="d-flex align-items-center justify-content-between" role="button" data-toggle="collapse" data-parent="#accordion" aria-expanded="true">
                            <span style="
                    ...
                    <div id="collapseFaq{{$count_faq}}" aria-labelledby="fBeginners Curious About Astrologyaq_{{$count_faq}}" class=" collapse" role="tabpanel">
