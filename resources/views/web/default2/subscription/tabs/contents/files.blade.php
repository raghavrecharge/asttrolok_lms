            ...
            @if(!empty($user) and $hasBought)
                <div class="d-flex align-items-center mt-20">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox"  id="fileReadToggle{{ $file->id }}" data-file-id="{{ $file->id }}" value="{{ $subscription->id }}" class="js-file-learning-toggle custom-control-input" @if(!empty($file->checkPassedItem())) checked @endif>
