        ...
        <div class="row login-container1">
            ...
            <div class="col-12 col-md-6">
                <div class="login-card">
                    ...
                    <form method="post" action="/register-free/learn-free-vedic-astrology-course-online" class="mt-35">
...
@endif
                    ...
                    <div class="text-center mt-20">
                        <span class="text-secondary">
                            ...
                            <a href="/login-free" class="text-secondary font-weight-bold">{{ trans('auth.login') }}</a>
                        </span>
                    </div>
