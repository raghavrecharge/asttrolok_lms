...
document.getElementById('amount').addEventListener('input', function() {
  ...
  jQuery(document).on('click', '#razor-pay-now', function (e) {
       ...
       $("input:radio").attr("checked", true);
          ...
          var   datadescription="Payment for the course {{ $webinar->title }} was successfully made via Razorpay throughour official website – Asttrolok, using a desktop (partpayment)";
