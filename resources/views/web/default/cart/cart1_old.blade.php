    ...
    <script>
        ...
        if(@json($hasPhysicalProduct))
        {
                ...
                if(city === ''){
                     ...
                     if(pin_code === '') {
                            $("input:radio").attr("checked", false);
                            $('#pin_code').after('<span class="text-strong textdanger" style="color:red;">Pin code is required</span>');
                            return false;
                        }
                        if(address === '') {
                            $("input:radio").attr("checked", false);
                            $('textarea[name="address"]').after('<span class="text-strong textdanger" style="color:red;">Address is required</span>');
                            return false;
                        }
                        if(message === '') {
                            $("input:radio").attr("checked", false);
                            $('#message').after('<span class="text-strong textdanger" style="color:red;">Message is required</span>');
                            return false;
              }
        }
