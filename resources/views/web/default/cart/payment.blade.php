...
@section('content')
    <section class="cart-banner position-relative text-center homehide">
        ...
        <span class="payment-hint font-20 text-white d-block" id="cartTotalDisplay">{{ handlePrice($total) . ' ' .  trans('cart.for_items',['count' => $count]) }}</span>
    </section>
    ...
    <section class="container mt-45">
        ...
        @if(auth()->check())
            ...
            @endif
        @endif
        <div class="price-box shadow-xs mb-20"> <span class="font-30 font-weight-bold">Total Amount </span> <span class="f-right font-30 text-primary" style="    float: right;" id="totalAmountDisplay">{{handlePrice($total)}}/-</span> </div>
