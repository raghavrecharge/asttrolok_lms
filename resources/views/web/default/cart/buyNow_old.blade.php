   ...
   <script src="{{ config('app.js_css_url') }}/assets2/default/js/parts/payment.min.js"></script>
    ...
    function addscript(){
        ...
        //var   databuttontext="product_price";
          var   datadescription="Payment for the course {{ $webinar->title }} was successfully made via Razorpay through our official website – Asttrolok, using a mobile(buynow)";
