            ...
            <div class="d-flex-center flex-column">
                @if(!empty($maintenanceSettings['image']))
                    <div class="maintenance-image">
                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $maintenanceSettings['image'] }}" alt="{{ $maintenanceSettings['title'] }}" class="img-cover">
                    </div>
                @endif
...
@push('scripts_bottom')
    ...
    <script   src="{{ config('app.js_css_url') }}/assets/default/js/parts/maintenance.min.js"></script>
@endpush
