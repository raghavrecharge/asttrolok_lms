@extends('web.default'.'.layouts.app') @push('styles_top')
...
<section class="mob-ban site-top-banner search-top-banner opacity-04 position-relative " style="height: 421px;background: url('https://storage.googleapis.com/astrolok/store/1/Courses/Cover/Background.jpg');background-repeat: no-repeat;background-size: cover;">
        <!--<img loading="lazy"  src="{{ config('app.img_dynamic_url') }}/store/1/about/category_cover.png.png" class="img-cover" alt="Instructors">-->

        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-9">
                    <div class="top-search-categories-form"  style="text-align: center;line-height: 3;">
                        <h1 class=" font-30" style="text-align: center;font-size: 35px;">Learn Astrology the Right Way</h1>
                        ...
                        <!--            <input type="text" name="search" class="form-control border-0" value="" placeholder="Search Instructors"/>-->
                                    <a href="/contact" class="mt-10 btn btn-primary rounded-pill py-25 px-40" style="font-size: 20px !important;font-weight: 600;">Talk to Our Team</a>
                                    <!--        </div>-->
                        <!--    </form>-->
                        <!--</div>-->
                    </div>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-5  mt-20">
            <div class="position-relative reward-program-section-hero-card">
                <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}/store/1/about/Section.png"  class="reward-program-section-hero" alt="Win Club Points" style="width: -webkit-fill-available;"/>
...
<section class="home-sections home-sections-swiper container  position-relative mt-25">
    <div class="row align-items-center ">
        <div class="col-12 col-lg-4">
            <div class="position-relative reward-program-section-hero-card">
                <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}/store/1/about/Alok ssir 2.png"  class="reward-program-section-hero" alt="Win Club Points" style="width: -webkit-fill-available;"/>
        ...
        <div class="col-12 col-lg-8 mt-20 mt-lg-0">
            <div class="">
                ...
                <p class="font-16 font-weight-normal text-dark mt-10">
                    <b class="font-16 font-weight-bold text-dark">Alok Khandelwal – Mentor & Co-Founder</b><br><br>
                    
                <ul class="ml-15">
                  <li style="list-style: disc;padding-top: 0px;">25+ years of experience in Vedic Astrology.</li>
    ...
    <div class="row" style="margin-bottom: 5%;">
        ...
        <div class="col-lg-12 pt-4 main_video pe-0 pe-sm-5 d-flex align-content-end" style="margin-bottom: 5%;">
            <div class="col-lg-12 video_container top_video p-0 me-0 me-sm-5" id="thumb_0">
                <iframe style="border-radius: 30px; cursor:pointer; text-align: center; width:100%; height:250px;" src="https://www.youtube.com/embed/7fCFk8leidM?si=ncBQnaUKr9ru9lLG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" data-gtm-yt-inspected-8="true"></iframe>
                <br> 
            </div>
        </div>
            ...
            <center>
                <div class="highlight_review_desktop">
                    <div class="highlight_review text-left mt-0">
                        ...
                        <img loading="lazy"  class="review_img" src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/review_images/05-min.jpg" alt="People">
                        <div class="review_name">Kartik Pathak</div>
                        <div class="review_location">Nagpur </div>
                        <div>
                            <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.png" alt="Star" width="20" height="19">
                            <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.png" alt="Star" width="20" height="19">
                            <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.png" alt="Star" width="20" height="19">
                            <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.png" alt="Star" width="20" height="19">
                            <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.png" alt="Star" width="20" height="19">
        ...
        <div class="col-sn-12 col-nd-7 col-lg-8">
            <div id="one" class="testimonial active">
                <div class="people_block">
                    <img loading="lazy"  class="person" src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/review_images/02-min.jpg" alt="People" width="100" height="100">
                    <div class="name_star">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                ...
                <div class="people_block">
                    <img loading="lazy"  class="person" src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/review_images/03-min.jpg" alt="People" width="100" height="100">
                    <div class="name_star">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                ...
                <div class="people_block">
                    <img loading="lazy"  class="person" src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/review_images/04-min.jpg" alt="People" width="100" height="100">
                    <div class="name_star">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                ...
                <div class="detail show-read-more">
                 ...
                 <div class="people_block">
                    <img loading="lazy"  class="person" src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/review_images/01-min.jpg" alt="People" width="100" height="100">
                    <div class="name_star">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                        <img loading="lazy"  src="https://asttrolok.in/public/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
...
<section class="home-sections home-sections-swiper container position-relative mt-25 homeshow">
    <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-4">
            <div class="position-relative reward-program-section-hero-card">
                <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}/store/1/about/composition-with-question-mark-nature-landscape 1.png"  class="reward-program-section-hero" alt="Win Club Points" style="width: -webkit-fill-available;"/>
...
<section class="mob-ban site-top-banner search-top-banner opacity-04 position-relative mt-50" style="height: 300px;background: #e8f3fa;border-radius: 15px;">
        <!--<img loading="lazy"  src="{{ config('app.img_dynamic_url') }}/store/1/about/category_cover.png.png" class="img-cover" alt="Instructors">-->
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-9">
                    <div class="top-search-categories-form"  style="text-align: center;line-height: 3;">
                        <h2 class=" font-30" style="text-align: center;font-size: 25px;">Start Your Astrology Journey With Alok Ji</h2>
