...
@section('content')
    ...
    <!--    <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ getPageBackgroundSettings('categories') }}" class="banner-redius img-cover" alt="{{ $pageTitle }} "/>-->
...
-->
            ...
            <!--        <span class="duration font-14 ml-5">150:00 Hours</span>-->
            <!--    </div>-->
            ...
            <!--        <span class="date-published font-14 ml-5">13 Sep 2024</span>-->
            <!--    </div>-->
            <!--</div>-->
