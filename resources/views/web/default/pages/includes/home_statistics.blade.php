                    ...
                    <div class="col mt-25 mt-lg-0 cats">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-10 px-5 w-100">
                            <div class="stat-icon-box teacher mt-10">
                                <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/stats/teacher.svg" alt="" class="img-fluid"/>
                            </div>
                    ...
                    <div class="col mt-25 mt-lg-0 cats">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-10 px-5 w-100">
                            <div class="stat-icon-box student mt-10">
                                <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/stats/student.svg" alt="" class="img-fluid"/>
                            </div>
                    ...
                    <div class="col mt-25 mt-lg-0 cats">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-10 px-5 w-100">
                            <div class="stat-icon-box video mt-10">
                                <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/stats/video.svg" alt="" class="img-fluid"/>
                            </div>
                    ...
                    <div class="col mt-25 mt-lg-0 cats">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-10 px-5 w-100">
                            <div class="stat-icon-box course mt-10">
                                <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/stats/course.svg" alt="" class="img-fluid"/>
                            </div>
                       ...
                       <a>   <div class="mx-10 px-20 mt-lg-0 mt-lg-0 cats mobile{{ $i }} ">
                            <div class="stats-item d-flex flex-column align-items-center text-center py-20 px-0 " style="width:100%;">
                               <a >   <div class="stat-icon-box" style="background-color: {{ $homeCustomStatistic->color }};padding: 0;">
                                    <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $homeCustomStatistic->icon }}" alt="{{ $homeCustomStatistic->title }}" class="img-fluid"/>
                                </div></a>
                                <a  class=" mt-15">
