...
@section('content')
    @if((!empty($webinars) and count($webinars)) or (!empty($products) and count($products)) or (!empty($teachers) and count($teachers)) or (!empty($organizations) and count($organizations) ) or (!empty($remedies) and count($remedies) ))
        <section class="site-top-banner search-top-banner opacity-04 position-relative">
            <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ getPageBackgroundSettings('search') }}" class="img-cover" alt=""/>
                            ...
                            <div class="col-6 col-md-3 col-lg-2 mt-30">
                                <div class="user-search-card text-center d-flex flex-column align-items-center justify-content-center">
                                    <div class="user-avatar">
                                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $teacher->getAvatar() }}" class="img-cover rounded-circle" alt="{{ $teacher->full_name }}">
                                    </div>
