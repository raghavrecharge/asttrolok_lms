<div class="mt-35">
    <div class="course-reviews-box row align-items-center">
        <div class="col-12 ml-15">
            <h2 class="section-title after-line">Reviews and ratings</h2>
            <div class="row">
            <div class="col-2 ">
            <div class="reviews-rate font-30 font-weight-bold ">{{ $course->course_rate }}
            </div>
            </div>
            <div class="col-10 ">
            <div class="">
...
">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.content_quality') }} </span>
                <span class="ml-15 font-14 text-gray text-left">({{ $course->reviews->count() > 0 ? round($course->reviews->avg('content_quality'), 1) : 0 }})</span>
            </div>
            <div class="d-flex ml-15 mt-5 align-items-center">
            @php
            $i = 5;
            @endphp
...
">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.instructor_skills') }} </span>
                <span class="ml-15 font-14 text-gray text-left">({{ $course->reviews->count() > 0 ? round($course->reviews->avg('instructor_skills'), 1) : 0 }})</span>
            </div>
            <div class="d-flex ml-15 mt-5 align-items-center">
            @php
            $i = 5;
...
">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.purchase_worth') }} </span>
                <span class="ml-15 font-14 text-gray text-left">({{ $course->reviews->count() > 0 ? round($course->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            <div class="d-flex ml-15 mt-5 align-items-center">
            @php
            $i = 5;
...
">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.support_quality') }} </span>
                <span class="ml-15 font-14 text-gray text-left">({{ $course->reviews->count() > 0 ? round($course->reviews->avg('support_quality'), 1) : 0 }})</span>
            </div>
            <div class="d-flex ml-15 mt-5 align-items-center">
            @php
            $i = 5;
    ...
    <div class="">
        ...
        @if($course->reviews->count() > 0)
            @foreach($course->reviews as $review)
                ...
                <div class="comments-card shadow-sm rounded-sm border px-20 py-15 mt-20" data-address="/reviews/store-reply-comment" data-csrf="{{ csrf_token() }}" data-id="{{ $review->id }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="user-inline-avatar d-flex align-items-center mt-10">
                            <div class="avatar bg-gray200">
                                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $review->creator->getAvatar() }}" class="img-cover" height='30' alt="{{ $review->creator->full_name }}">
                            </div>
                        ...
                        @foreach($review->comments as $comment)
                            <div class="shadow-lg rounded-sm border px-20 py-15 mt-30">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="user-inline-avatar d-flex align-items-center mt-10">
                                        <div class="avatar bg-gray200">
                                            <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $comment->user->getAvatar() }}" class="img-cover" alt="{{ $comment->user->full_name }}">
                                        </div>
                                        <div class="d-flex flex-column ml-5">
    ...
    <form action="/reviews/store" class="mt-20" method="post">
        ...
        <div class="reviews-stars row align-items-center">
            ...
            <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                ...
                <select name="content_quality" data-rate="5">
            ...
            <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                ...
                <select name="instructor_skills" data-rate="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
            ...
            <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                ...
                <select name="purchase_worth" data-rate="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
            ...
            <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                ...
                <select name="support_quality" data-rate="5">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
