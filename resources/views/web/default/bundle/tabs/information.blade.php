...
@php
    ...
    $companyLogosExtraDescription = !empty($bundle->webinarExtraDescription) ? $bundle->webinarExtraDescription->where('type','company_logos') : null;
    $requirementsExtraDescription = !empty($bundle->webinarExtraDescription) ? $bundle->webinarExtraDescription->where('type','requirements') : null;
@endphp
    ...
    <div class="mt-30">
        ...
        <div class="forums-featured-card align-items-center bg-white p-20 p-md-35 shadow-lg rounded-lg mt-15">
            <div class="forums-featured-card-icon" style="width: 100%; ">
                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/faqs/Alok-sir1.png" alt="What is social media?" class="img-cover">
            </div>

            <div class=" mt-20">
                <center><h4 class="font-20 font-weight-bold text-dark">Mr. Alok Khandelwal</h4></center><br>
                <p class="font-14 text-gray">Mr. Alok Khandelwal is not only recognized for his exceptional astrological expertise but also for his global impact. He extends his teachings beyond borders, making Vedic Knowledge reach students in countries like Russia with the help of professional translators.</p><br>
                <p class="font-14 text-gray">Moreover, Mr. Khandelwal's passion for sharing knowledge takes him to various countries where he engages in public speaking, teaching, and consultation, and delivers introductory talks on Vedic science with a project called Unwinding.</p><br>
                <p class="font-14 text-gray">With over 35,000 students already taught and hundreds more added each year, Mr. Khandelwal's impact continues to grow. He is highly regarded for his expertise in Ancient Vedic Astrology and interpersonal skills, offering practical solutions to professional, personal, emotional, and mental challenges. Additionally, he holds membership in the esteemed 'Art of Living' foundation and is sought-after as a guest speaker in prestigious institutions nationwide.</p>
            </div>
        </div>
    </div>
    @endif
                ...
                <div class="col-sn-12 col-nd-7 col-lg-8">
                    <div id="one" class="testimonial active">
                        <div class="people_block">
                            <img loading="lazy" class="person" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/review_images/02-min.jpg" alt="People" width="100" height="100">
                            <div class="name_star">
                        ...
                        <div class="people_block">
                            <img loading="lazy" class="person" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/review_images/03-min.jpg" alt="People" width="100" height="100">
                            <div class="name_star">
                                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
                                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/css/landingPage/resources/img/star.webp.html" alt="Star" width="20" height="19">
