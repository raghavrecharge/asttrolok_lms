...
@section('content')
    <div class="container">
        <div class="row login-container">
            <div class="col-12 col-md-6 pl-0">
                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ getPageBackgroundSettings('certificate_validation') }}" class="img-cover" alt="Login">
            </div>
    ...
    <div id="certificateModal" class="d-none">
        ...
        <div class="mt-25 d-flex flex-column align-items-center">
            <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/check.png" alt="" width="120" height="117">
...
@push('scripts_bottom')
    ...
    <script src="{{ config('app.js_css_url') }}/assets/default/js/parts/certificate_validation.min.js"></script>
@endpush
