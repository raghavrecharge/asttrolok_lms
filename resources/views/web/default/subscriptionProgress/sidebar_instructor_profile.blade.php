<div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
    ...
    <div class="teacher-avatar mt-5">
        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $subscriptionTeacher->getAvatar(100) }}" class="img-cover" alt="{{ $subscriptionTeacher->full_name }}">

        @if($subscriptionTeacher->offline)
        ...
        @elseif($subscriptionTeacher->verified)
    ...
    <h3 class="mt-10 font-16 font-weight-bold text-secondary">{{ $subscriptionTeacher->full_name }}</h3>
    <span class="mt-5 font-14 font-weight-500 text-gray text-center">{{ $subscriptionTeacher->bio }}</span>
