        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <div class="lazyImage product-show-image-card position-relative">
                    <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $product->thumbnail }}" alt="{{ $product->title }}" class="main-s-image img-cover rounded-lg" loading="lazy">
                    ...
                    @if(!empty($product->video_demo))
                        <button id="productDemoVideoBtn"
                            ...
                            <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/icons/play-bold.svg" alt="play icon" class=""/>
                        </button>
                    @endif
                </div>
                ...
                <div class="product-show-thumbnail-card d-flex align-items-center mt-20">
                    <div class="thumbnail-card is-first-thumbnail-card cursor-pointer position-relative">
                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $product->thumbnail }}" alt="{{ $product->title }}" class="img-cover rounded-sm">
                    ...
                    @if(!empty($product->images) and count($product->images))
                        @foreach($product->images as $image)
                            <div class="thumbnail-card cursor-pointer ml-20 ml-lg-35">
                                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $image->path }}" alt="{{ $product->title }}" class="img-cover rounded-sm">
                            </div>
                        @endforeach
                    @endif
                </div>
...
@push('scripts_bottom')
    ...
    <script   src="{{ config('app.js_css_url') }}/assets/default/js/parts/product_show.min.js"></script>
@endpush
