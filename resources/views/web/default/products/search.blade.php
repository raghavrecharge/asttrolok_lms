...
@section('content')
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ getPageBackgroundSettings('products_lists') }}" class="img-cover" alt=""/>
...
@push('scripts_bottom')
    <script  src="{{ config('app.js_css_url') }}/assets/default/js/parts/products_lists.min.js"></script>
@endpush
