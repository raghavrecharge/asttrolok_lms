        ...
        @if(!empty($defaultPackage))
            <div class="d-flex align-items-center flex-column flex-lg-row mt-50 border rounded-lg p-15 p-lg-25">
                <div class="default-package-icon">
                    <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/become-instructor/default.png" class="img-cover" alt="{{ trans('update.default_package') }}">
                </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                        ...
                        <div class="d-flex align-items-center mt-20">
                            <div class="default-package-statistics-icon">
                                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/icons/play.svg" alt="play">
                            </div>
                        ...
                        <div class="d-flex align-items-center mt-20">
                            <div class="default-package-statistics-icon">
                                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/icons/video-2.svg" alt="video-2">
                            </div>
                        ...
                        <div class="d-flex align-items-center mt-20">
                            <div class="default-package-statistics-icon">
                                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/icons/clock.svg" alt="clock">
                            </div>
                        ...
                        @if($selectedRole == 'organizations')
                            <div class="d-flex align-items-center mt-20">
                                <div class="default-package-statistics-icon">
                                    <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/icons/users.svg" alt="users">
                                </div>
                            ...
                            <div class="d-flex align-items-center mt-20">
                                <div class="default-package-statistics-icon">
                                    <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/icons/user.svg" alt="user">
                                </div>
...
@push('scripts_bottom')
    <script   src="{{ config('app.js_css_url') }}/assets/default/js/parts/become_instructor.min.js"></script>
@endpush
