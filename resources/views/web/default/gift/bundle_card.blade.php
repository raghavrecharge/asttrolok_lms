    ...
    <figure>
        <div class="image-box">
            <a href="{{ $bundle->getUrl() }}">
                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $bundle->getImage() }}" class="img-cover" alt="{{ $bundle->title }}">
            </a>
        </div>
        ...
        <figcaption class="mt-10">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $bundle->teacher->getAvatar() }}" class="img-cover" alt="{{ $bundle->teacher->full_name }}">
                </div>
