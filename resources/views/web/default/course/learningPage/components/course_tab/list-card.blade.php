<div class="webinar-card list-card webinar-list webinar-list-2 d-flex mt-0 loadmorelist">
    <div class="image-box">
        ...
        @endif
            ...
            @endif
            <img loading="lazy" loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $webinar->getImage() }}" class="img-cover" alt="{{ $webinar->title }}">
        </a>
    ...
    <div class="webinar-card-body w-100 d-flex flex-column">
       ...
       {{-- @include(getTemplate() . '.includes.webinar.rate3',['rate' => $webinar->getRate()]) --}}
        ...
        <div class="d-flex justify-content-between mt-auto">
            ...
            <a href="{{ $webinar->getUrl() }}">
            @endif
                <button type="submit" class="btn btn-primary rounded-pill buynow" style="font-size: 0.51rem !important;">BUY NOW</button>
                </a>
            </div>
        </div>
    </div>
