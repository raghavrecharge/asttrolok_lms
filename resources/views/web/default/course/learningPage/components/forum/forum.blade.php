    ...
    <div class="course-forum-top-stats d-flex flex-wrap flex-md-nowrap align-items-center justify-content-around">
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/activity/47.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img loading="lazy" loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/activity/120.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/activity/119.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/activity/39.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/activity/49.svg" class="course-forum-top-stats__icon" alt="">
                ...
                <div class="col-12 col-lg-6">
                    <div class="d-flex align-items-start">
                        <div class="question-user-avatar">
                            <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $forum->user->getAvatar(64) }}" class="img-cover rounded-circle" alt="{{ $forum->user->full_name }}">
                        </div>
                        <div class="ml-10">
                ...
                <div class="col-12 col-lg-6 mt-15 mt-lg-0 border-left">
                    @if($course->isOwner($user->id))
                        <button type="button" data-action="{{ $course->getForumPageUrl() }}/{{ $forum->id }}/pinToggle" class="question-forum-pin-btn d-flex align-items-center justify-content-center">
                            <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/learning/{{ $forum->pin ? 'un_pin' : 'pin' }}.svg" alt="pin icon" class="">
                        </button>
                    @endif
                                    ...
                                    @if(!empty($forum->usersAvatars))
                                        @foreach($forum->usersAvatars as $userAvatar)
                                            <div class="user-avatar-card rounded-circle">
                                                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $userAvatar->getAvatar(32) }}" class="img-cover rounded-circle" alt="{{ $userAvatar->full_name }}">
                                            </div>
                                        @endforeach
                                    @endif
                        ...
                        <div class="py-15 border-top position-relative">
                            ...
                            <div class="d-flex align-items-start mt-20">
                                <div class="last-answer-user-avatar">
                                    <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $forum->lastAnswer->user->getAvatar(30) }}" class="img-cover rounded-circle" alt="{{ $forum->lastAnswer->user->full_name }}">
                                </div>
                                <div class="ml-10">
...
@else
    <div class="learning-page-forum-empty d-flex align-items-center justify-content-center flex-column">
        <div class="learning-page-forum-empty-icon d-flex align-items-center justify-content-center">
            <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/learning/forum-empty.svg" class="img-fluid" alt="">
        </div>
