    ...
    <div class="container">
        ...
        <div class="row login-container1">
            ...
            <div class="col-12 col-md-6 pl-0" style="display: flex;flex-wrap: nowrap;align-items: center;">
                <div >
                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}/store/1/default_images/01.jpg" class="img-cover" style="height:auto;" alt="Login">
                </div>
            </div>
...
@endif
                        ...
                        <div class="form-group">
                            ...
                            <input name="slug" type="hidden" id="slug" value="learn-free-astrology-course-english" >
                            @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    @if(!empty(getFeaturesSettings('show_facebook_login_button')))
                        <a href="{{url('/facebook/redirect')}}" target="_blank" class="social-login mt-20 p-10 text-center d-flex align-items-center justify-content-center ">
                            <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/auth/facebook.svg" class="mr-auto" alt="facebook svg"/>
