    ...
    <div class="container">
        <div class="row login-container1">
            <div class="col-12 col-md-6 pl-0"  style="display: flex;flex-wrap: nowrap;align-items: center;">
                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ getPageBackgroundSettings('register') }}"  style="height:auto;" class="img-cover" alt="Login">
            </div>
            <div class="col-12 col-md-6">
                <div class="login-card">
                    <h1 class="font-20 font-weight-bold">{{ trans('auth.signup') }}</h1>

                    <form method="post" action="/register-course/Free-Astrology-Course" class="mt-35">
...
@endif
                        ...
                        <div class="form-group">
                            ...
                            <input name="amount" maxlength="50" type="text" value="{{ old('amount') }}" class="form-control @error('amount') is-invalid @enderror">
                            @error('amount')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
