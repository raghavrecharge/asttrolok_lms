...
@section('content')
    <section class=" course-cover-container {{ empty($activeSpecialOffer) ? 'not-active-special-offer' : '' }}">
         @if($course->id == 2102)
         <img loading="lazy"src="{{ config('app.img_dynamic_url') }}/store/1/banner/Mobile-min.jpg" class=" course-cover-img" alt="{{ $course->title }}" style="border-radius: 20px;"/>
        @else
          <img loading="lazy"src="{{ asset('assets/default/img/course/video-banner.svg') }}" class=" course-cover-img" alt="{{ $course->title }}"/>
         @endif
        <div class="cover-content pt-40 pt-80">
            <div class="container position-relative">
              {{--  @if(!empty($activeSpecialOffer))
                ...
                @endif --}}
                {{-- <h2 class="font-30 course-title text-center py-10">{{ clean($course->title, 't') }}</h2> --}}
                <div class="row">
                    <div class="col-12 col-lg-6 course-section-top">
                        {{-- <div class="course-img text-center {{ $course->video_demo ? 'has-video' :'' }}"> --}}

                        {{-- <img loading="lazy"src="{{ config('app.img_dynamic_url') }}{{ $course->getImage() }}" class="img-cover"  alt="webinar Demo Video"> --}}
...
<!--                        </div>-->
                    ...
                    <!--    </div>-->
                        <div class="pt-50  align-items-left align-items-start justify-content-between ">
                            <div class="d-flex frame-427322372-acu" id="1017:948">
                                ...
                                @if($course->id == 2070 or $course->id == 2069 or $course->id == 2102 )
                    ...
                    {{-- <div class="col-12 col-lg-6 text-center course-section-top">
                        ...
                        <img loading="lazy"src="{{ config('app.img_dynamic_url') }}{{ $course->getImageCover() }}" class="img-cover"  alt="webinar Demo Video">
...
<div class="row mt-lg-40 align-items-center font-14">
            <a href="https://www.youtube.com/@ASTTROLOKChannel?sub_confirmation=1" target="_blank" class="row m-0 col-6 p-5">
             ...
             <a href="https://www.facebook.com/Asttrolok/" target="_blank" class="row m-0 col-6 p-5">
                ...
                <span class="col-6 mt-5 d-block p-0"><b>125.9k</b> <br/>Likes</span>
            </a>
...
--}}
                            ...
                            @endif
                        @else
                        <div class="course-body-on-cover text-white" style="min-height: 0px;"></div>
                        @endif
                    </div>
...
@if($course->id == 2102 || $course->id == 2107)
    {{-- Start Date --}}
    <div class="mt-20 d-flex align-items-center text-gray" style="flex-wrap: nowrap;">
        <i data-feather="calendar" width="{{ $iconSize }}" height="{{ $iconSize }}"></i>
        <span class="ml-5 font-14 font-weight-500 text-truncate">
            Start Date – {{ $course->id == 2102 ? '12th December, 2025' : '19th March 2026' }}
        </span>
    </div>

    {{-- Class Time --}}
    <div class="mt-20 d-flex align-items-center text-gray" style="flex-wrap: nowrap;">
        <i data-feather="clock" width="{{ $iconSize }}" height="{{ $iconSize }}"></i>
        <span class="ml-5 font-14 font-weight-500 text-truncate">
            Class Time – Every Saturday, 7-9 PM IST
        </span>
    </div>

    {{-- Language --}}
    <div class="mt-20 d-flex align-items-center text-gray" style="flex-wrap: nowrap;">
        <i data-feather="globe" width="{{ $iconSize }}" height="{{ $iconSize }}"></i>
        <span class="ml-5 font-14 font-weight-500 text-truncate">
            Language – {{ $course->id == 2102 ? 'English' : 'Hindi' }}
        </span>
    </div>

    {{-- Certification --}}
    <div class="mt-20 d-flex align-items-center text-gray" style="flex-wrap: nowrap;">
        <i data-feather="award" width="{{ $iconSize }}" height="{{ $iconSize }}"></i>
        <span class="ml-5 font-14 font-weight-500 text-truncate">
    ...
    {{-- Duration --}}
    <div class="mt-20 d-flex align-items-center text-gray" style="flex-wrap: nowrap;">
        <i data-feather="check-circle" width="{{ $iconSize }}" height="{{ $iconSize }}"></i>
        <span class="ml-5 font-14 font-weight-500 text-truncate">
            Duration – 3 Months
        </span>
    </div>
@endif
                ...
                <div class="row">
                            ...
                            <!--        <img loading="lazy"src="/store/1/default_images/banners/Astromany-course.jpg" class="img-cover rounded-lg" alt="">-->
                            <!--    </a>-->
                            <!--</div>-->
                            <!--  <div class="rounded-lg sidebar-ads mt-35 col-12">-->
                            <!--    <a href="https://lms.asttrolok.com/course/Professional-Astrology-Course">-->
                            <!--        <img loading="lazy"src="/store/1/default_images/banners/Asttrology-course.jpg" class="img-cover rounded-lg" alt="">-->
                            <!--    </a>-->
                            <!--</div>-->
    ...
    <figure>
        <div class="image-box">
           <span class="badge badge-primary">Course</span>
            ...
            <a href="https://asttrolok.com/course/{{ $course_Professional->slug }}">
                <img loading="lazy"src="{{ config('app.img_dynamic_url') }}{{ $course_Professional->thumbnail }}" class="img-cover" alt="{{ $course_Professional->slug }}">
            </a>
        ...
        <figcaption class="webinar-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img loading="lazy"src="{{ config('app.img_dynamic_url') }}{{ $course_Professional->teacher->avatar }}" class="img-cover" alt="{{ $course_Professional->full_name }}">
                </div>
...
<div class="container demo">
    ...
    <a href="{{ $course->getLearningPageUrl() }}" class="buy-btn1 btn btn-primary">{{ trans('update.go_to_learning_page') }}</a>
    @else
        @if($course->slug == 'learn-free-vedic-astrology-course-online')
            @if(empty($authUser))
                <a href="/register-free" class="buy-btn1 btn btn-primary {{ (!$canSale) ? (' disabled ' . $course->cantSaleStatus($hasBought)) : '' }}">{{ trans('public.enroll_on_webinar') }}</a>
            @else
                <a href="{{ $canSale ? '/course/'. $course->slug .'/free' : '#' }}" class="buy-btn1 btn btn-primary {{ (!$canSale) ? (' disabled ' . $course->cantSaleStatus($hasBought)) : '' }}">{{ trans('public.enroll_on_webinar') }}</a>
            @endif
        @elseif($course->slug == 'learn-free-astrology-course-english')
