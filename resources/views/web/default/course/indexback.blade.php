                    ...
                    <!--    </div>-->
                        <div class="pt-50  align-items-left align-items-start justify-content-between ">
                            <div class="d-flex frame-427322372-acu" id="1017:948">
                                ...
                                <img loading="lazy"  class="frame-427322370-8wF" src="{{ asset('assets/default/img/course/play-button.svg') }}" alt="play-button" id="1017:938"/>
                                ...
                                <img loading="lazy"  class="frame-427322370-8wF" src="{{ asset('assets/default/img/course/green-video-icon (2).svg') }}" alt="green-video-icon" id="1017:939"/>
                                ...
                                <img loading="lazy"  class="frame-427322370-8wF" src="{{ asset('assets/default/img/course/ind-ruppes.svg') }}" alt="ind-ruppes" id="864:10420"/>
