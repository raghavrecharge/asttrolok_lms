                ...
                <div class="table-responsive">
                    <table class="table text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center d-none d-md-table-cell">{{ trans('update.replies') }}</th>
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td class="text-center d-none d-lg-table-cell"><span class="fm-forum-tag">{{ $post->topic->forum->title }}</span></td>
                                <td class="text-center d-none d-md-table-cell"><span class="fm-replies-count">{{ $post->replies_count }}</span></td>
                                <td class="text-center d-none d-md-table-cell" style="font-size:12px;color:#6c757d;white-space:nowrap;">{{ dateTimeFormat($post->created_at, 'j M Y H:i') }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
