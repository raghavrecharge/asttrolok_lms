            ...
            <div class="form-group">
                ...
                <div id="mapContainer" class="d-none">
                    ...
                    <div class="region-map mt-10" id="mapBox"
                         data-zoom="12"
                    >
                        <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/location.png" class="marker">
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts_bottom')
    ...
    <script   src="{{ config('app.js_css_url') }}/assets/default/js/panel/user_settings_tab.min.js"></script>
@endpush
