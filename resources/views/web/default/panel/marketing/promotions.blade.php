            ...
            @foreach($promotions as $promotion)
                <div class="col-12 col-sm-6 col-lg-3 mt-15">
                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                        ...
                        <div class="plan-icon">
                            <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $promotion->icon }}" class="img-cover" alt="">
                        </div>
...
@push('scripts_bottom')
    ...
    <script   src="{{ config('app.js_css_url') }}/assets/default/js/panel/marketing/promotions.min.js"></script>
@endpush
