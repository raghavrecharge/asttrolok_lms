                ...
                <div class="p-15 rounded-sm panel-shadow bg-white h-100">
                    <div class="row">
                        <div class="col-5 d-flex align-items-center justify-content-center">
                            <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/rewards/registration_bonus.png" class="img-fluid" alt="{{ trans('update.registration_bonus') }}">
                        </div>
                ...
                <div class="p-15 rounded-sm panel-shadow bg-white h-100">
                    <div class="row">
                                ...
                                @if(!empty($termItem['icon']) and !empty($termItem['title']) and !empty($termItem['description']))
                                    <div class="how-to-get-bonus-items d-flex align-items-start">
                                        <div class="icon-box d-flex align-items-center justify-content-center">
                                            <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $termItem['icon'] }}" alt="{{ $termItem['title'] }}" width="16" height="16">
                                        </div>
                                        <div class="ml-10">
                        ...
                        @if(!empty($registrationBonusTermsSettings['term_image']))
                            <div class="col-5 d-flex align-items-center justify-content-center">
                                <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $registrationBonusTermsSettings['term_image'] }}" class="img-fluid" alt="{{ trans('update.how_to_get_bonus') }}">
                            </div>
                        @endif
                    </div>
                </div>
                                            ...
                                            <td class="text-left">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar bg-gray200">
                                                        <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $user->getAvatar() }}" class="img-cover" alt="{{ $user->full_name }}">
                                                    </div>
                                                    <div class=" ml-5">
            ...
            @else
                <div class="no-result my-50 d-flex align-items-center justify-content-center flex-column">
                    <div class="no-result-logo">
                        <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/no-results/no_followers.png" alt="{{ trans('update.no_referred_users') }}">
                    </div>
