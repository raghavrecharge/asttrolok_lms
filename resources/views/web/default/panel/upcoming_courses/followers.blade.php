                ...
                <div class="px-30 h-100">
                            ...
                            @foreach($followers as $follower)
                                <div class="d-flex align-items-center mt-20">
                                    <div class="size-50 rounded-circle">
                                        <img src="{{ config('app.img_dynamic_url') }}{{ $follower->user->getAvatar(50) }}" alt="{{ $follower->user->full_name }}" class="img-cover rounded-circle">
                                    </div>
                                    <div class="ml-10">
                    ...
                    @else
                        <div class="d-flex-center flex-column h-100 text-center">
                            <img src="{{ config('app.js_css_url') }}/assets/default/img/upcoming/no_followers.svg" alt="no followers" width="251" height="239">
            ...
            <div class="col-12 col-lg-6 py-15">
                <div class="d-flex justify-content-center flex-column h-100">
                    <div class="d-flex-center flex-column text-center flex-grow-1 mt-20 mt-lg-0">
                        <div class="">
                            <img src="{{ config('app.js_css_url') }}/assets/default/img/upcoming/send_notification.svg" alt="send notification" width="274" height="240">
                        </div>
