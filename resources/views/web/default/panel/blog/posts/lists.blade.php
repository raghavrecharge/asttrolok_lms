                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center d-none d-lg-table-cell">{{ trans('public.category') }}</th>
                                    <th class="text-center d-none d-md-table-cell">{{ trans('panel.comments') }}</th>
                                    <th class="text-center d-none d-md-table-cell">{{ trans('update.visit_count') }}</th>
                                    <th class="text-center">{{ trans('public.status') }}</th>
                                    <th class="text-center d-none d-lg-table-cell">{{ trans('public.date_created') }}</th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle d-none d-lg-table-cell">{{ $post->category->title }}</td>
                                        <td class="text-center align-middle d-none d-md-table-cell">{{ $post->comments_count }}</td>
                                        <td class="text-center align-middle d-none d-md-table-cell">{{ $post->visit_count }}</td>
                                        ...
                                        <td class="text-center align-middle d-none d-lg-table-cell">{{ dateTimeFormat($post->created_at, 'j M Y H:i') }}</td>
                                        <td class="text-center align-middle">
