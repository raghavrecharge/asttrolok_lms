@push('styles_top')
    ...
    <link rel="stylesheet" href="{{ config('app.js_css_url') }}/assets/default/vendors/bootstrap-tagsinput/bootstrap-tagsinput.min.css">
@endpush
...
@push('scripts_bottom')
    <scription   src="{{ config('app.js_css_url') }}/assets/default/vendors/select2/select2.min.js"></script>
    <scription   src="{{ config('app.js_css_url') }}/assets/default/vendors/moment.min.js"></script>
    <scription   src="{{ config('app.js_css_url') }}/assets/default/vendors/daterangepicker/daterangepicker.min.js"></script>
    <scription   src="{{ config('app.js_css_url') }}/assets/default/vendors/bootstrap-tagsinput/bootstrap-tagsinput.min.js"></script>
@endpush
