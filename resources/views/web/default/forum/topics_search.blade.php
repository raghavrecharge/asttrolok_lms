                                                ...
                                                @if(!empty($topic->lastPost))
                                                    <div class="d-flex align-items-center">
                                                        <div class="topic-last-post-user-avatar rounded-circle">
                                                            <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $topic->lastPost->user->getAvatar(30) }}" class="img-cover rounded-circle" alt="{{ $topic->lastPost->user->full_name }}">
                                                        </div>
                                                        <div class="ml-10">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="rounded-lg p-15 border bg-white mt-20">
                        ...
                        @foreach($popularTopics as $popularTopic)
                            <div class="d-flex align-items-center mt-15">
                                <div class="topics-right-side-user-avatar rounded-circle">
                                    <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $popularTopic->creator->getAvatar(48) }}" class="img-cover rounded-circle" alt="{{ $popularTopic->creator->full_name }}">
                                </div>
                                <div class="ml-10">
