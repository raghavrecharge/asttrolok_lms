...
@section('content')
    <section class="forum-hero-section mt-50 position-relative">
        ...
        <div class="forum-hero-section__image">
            <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/forum/hero.png" class="img-cover" alt="forum hero">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/forum/1.svg" alt="{{ trans('update.forums') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/forum/2.svg" alt="{{ trans('update.topics') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/forum/3.svg" alt="{{ trans('site.posts') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/forum/4.svg" alt="{{ trans('update.members') }}" class="forum-stat-icon"/>
            ...
            @foreach($featuredTopics as $featuredTopic)
                <div class="forums-featured-card d-flex align-items-center bg-white p-20 p-md-35 rounded-lg mt-15">
                    <div class="forums-featured-card-icon">
                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $featuredTopic->icon }}" alt="{{ $featuredTopic->topic->title }}" class="img-cover">
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-15">
                        <div class="forum-recommended-topics__card position-relative rounded-lg bg-white px-20 py-30">
                            <div class="forum-recommended-topics__icon">
                                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $recommendedTopic->icon }}" alt="{{ $recommendedTopic->title }}" class="img-cover">
                            </div>
