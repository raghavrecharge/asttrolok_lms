                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="d-flex align-items-center">
                                                <div class="topic-user-avatar rounded-circle">
                                                    <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $topic->creator->getAvatar() }}" class="img-cover rounded-circle" alt="{{ $topic->creator->full_name }}">
                                                </div>
                                                ...
                                                <div class="col-3 d-flex align-items-center">
                                                    @if($topic->pin)
                                                        <div class="topics-lists-card__icons rounded-circle mr-10">
                                                            <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/learning/un_pin.svg" alt="" class="img-cover rounded-circle">
                                                        </div>
                                                    @endif

                                                    @if($topic->close)
                                                        <div class="topics-lists-card__icons rounded-circle">
                                                            <img loading="lazy"  src="{{ config('app.js_css_url') }}/assets/default/img/learning/lock.svg" alt="" class="img-cover rounded-circle">
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    @if(!empty($topic->lastPost))
                                                        <div class="d-flex align-items-center">
                                                            <div class="topic-last-post-user-avatar rounded-circle">
                                                                <img loading="lazy"  src="{{ $topic->lastPost->user->getAvatar(30) }}" class="img-cover rounded-circle" alt="{{ $topic->lastPost->user->full_name }}">
                                                            </div>
                                                            <div class="ml-10">
                                ...
                                @if(!empty($topUser->all_posts))
                                    <div class="d-flex align-items-center mt-15">
                                        <div class="topics-right-side-user-avatar rounded-circle">
                                            <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $topUser->getAvatar(48) }}" class="img-cover rounded-circle" alt="{{ $topUser->full_name }}">
                                        </div>
                                        <div class="ml-10">
                    ...
                    @if(!empty($popularTopics) and count($popularTopics))
                        <div class="rounded-lg p-15 border bg-white mt-20">
                            ...
                            @foreach($popularTopics as $popularTopic)
                                <div class="d-flex align-items-center mt-15">
                                    <div class="topics-right-side-user-avatar rounded-circle">
                                        <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ !empty($popularTopic->creator) ? $popularTopic->creator->getAvatar(48) : '' }}" class="img-cover rounded-circle" alt="{{ !empty($popularTopic->creator) ? $popularTopic->creator->full_name : '' }}">
                                    </div>
                                    <div class="ml-10">
