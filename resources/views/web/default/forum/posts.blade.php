    ...
    <div class="container mt-35 mt-md-50">
        ...
        @if(!auth()->check())
            <div class="reply-login-close-card d-flex flex-column align-items-center w-100 p-15 rounded-lg border bg-white mt-15 p-40">
                <div class="icon-card">
                    <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/topics/login.svg" alt="login icon" class="img-cover">
                </div>
        ...
        @elseif($topic->close or $forum->close)
            <div class="reply-login-close-card d-flex flex-column align-items-center w-100 p-15 rounded-lg border bg-white mt-15 p-40">
                <div class="icon-card">
                    <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/topics/closed.svg" alt="closed icon" class="img-cover">
                </div>
