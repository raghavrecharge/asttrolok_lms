    ...
    <div class="mt-20">
        <form action="/comments/store" method="post">
            ...
            <div class="form-group">
                <textarea name="comment" maxlength="500" class="form-control @error('comment') is-invalid @enderror" rows="5"></textarea>
                    ...
                    @foreach($comment->replies as $reply)
                        <div class="rounded-sm border px-20 py-15 mt-30">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="user-inline-avatar d-flex align-items-center mt-10">
                                    <div class="avatar bg-gray200">
                                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $reply->user->getAvatar() }}" class="img-cover" alt="">
                                    </div>
                                    <div class="d-flex flex-column ml-5">
