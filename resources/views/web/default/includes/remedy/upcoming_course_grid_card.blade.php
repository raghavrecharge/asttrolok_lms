    ...
    <figure>
        <div class="image-box">
            ...
            <a href="{{ $upcomingCourse->getUrl() }}">
                <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $upcomingCourse->getImage() }}" class="img-cover" alt="{{ $upcomingCourse->title }}">
            </a>
        ...
        <figcaption class="webinar-card-body">
            <div class="user-inline-avatar d-flex align-items-center">
                <div class="avatar bg-gray200">
                    <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $upcomingCourse->teacher->getAvatar() }}" class="img-cover" alt="{{ $upcomingCourse->teacher->full_name }}">
                </div>
