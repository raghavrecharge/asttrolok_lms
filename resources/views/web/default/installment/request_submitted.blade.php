...
<img src="/success.gif" alt="{{ trans('cart.success_pay_title') }}" width="267" height="265" style=" height:auto; mix-blend-mode:multiply;">
    
                        <h1 class="font-20 mt-30">{{ trans('cart.success_pay_title') }}</h1>
                        <p class="font-14 text-gray mt-5">{!! trans('cart.success_pay_msg') !!}</p>
    
                        <a href="{{ $lmsUrl }}" class="btn btn-primary mt-15">{{ trans('public.my_panel') }}</a>
                    </div>
                </div>
            </div>
        </div>
...
<img src="/success.gif" alt="{{ trans('cart.success_pay_title') }}" width="267" height="265"style=" height:auto; mix-blend-mode:multiply;">
                        ...
                        <h1 class="font-20 mt-30 text-center">{{ ucfirst(request()->get('payment_type', 'N/A')) }}
 Request Submitted</h1>
                        {{-- <p class="font-14 text-gray mt-5">{{ request()->get('payment_type') }} request</p> --}}
    
                        <a href="{{ $lmsUrl }}" class="btn btn-primary mt-15">Dashboard</a>
                    </div>
                </div>
            </div>
        </div>
