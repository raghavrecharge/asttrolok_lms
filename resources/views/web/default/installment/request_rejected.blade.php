        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-md-8">
                <div class="installment-request-card d-flex align-items-center justify-content-center flex-column border rounded-lg">
                    <img loading="lazy" src="{{ config('app.js_css_url') }}/assets/default/img/installment/request_rejected.svg" alt="{{ trans('update.installment_request_rejected') }}" width="267" height="265">
