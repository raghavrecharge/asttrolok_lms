...
<span class="f-right font-30 text-primary" style="    float: right;">{{ handlePrice($totalPayments) }}/-</span>
                ...
                <div class=" p-15 mt-2 mx-0 shadow-sm" style="border: 1px solid #e1e1e1;border-radius: 10px;">
                <p class="text-gray font-18 text-ellipsis1">{!! nl2br($installment->description) !!}</p>
            </div>
