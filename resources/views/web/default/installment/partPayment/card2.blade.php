...
<script defer  type="text/javascript">
    ...
    <!--<script defer  src="/assets/default/js/parts/get-regions.min.js"></script>-->
    <script src="{{ config('app.js_css_url') }}/assets/default/js/parts/cart1.min.js"></script>
    <!--<script defer  src="/assets/default/js/parts/cart.min.js"></script>-->
    <!--<script defer  src="/assets/default/js/parts/payment.min.js"></script>-->
@endpush