    ...
    <div class="row">
        <div class="col-md-8">
            ...
            @if(!empty($installment->banner))
                <div class="mt-20">
                    <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}{{ $installment->banner }}" alt="{{ $installment->main_title }}" class="img-fluid">
                </div>
                @else
                
                <div class="default-package-icon mt-20">
                <img loading="lazy"  src="/assets2/default/img/become-instructor/default.png" class="img-cover" alt="{{ trans('update.installment_overview') }}" width="176" height="144">
            </div>
            @endif
          ...
          <form action="/payments/payment-request" method="post" id="razor-pay-request" class=" mt-25 " >
            ...
            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="amount" id='amount'  placeholder="Amount" type="text" value="{{$item->slug=='astrology-basic-level'?5000:null}}" class="form-control @error('number') is-invalid @enderror"  readonly >
                            @else
                            <input name="amount" id='amount'  placeholder="Amount" type="text" value="{{$item->slug=='astrology-basic-level'?5000:null}}" class="form-control @error('number') is-invalid @enderror"   >
                            @endif
                            @error('amount')
                            <div class="invalid-feedback">
                                {{ $message }}
               ...
               {{-- <div class="col-12 col-lg-6 mb-20 charge-account-radio ">
                    ...
                    <label for="offline" class="rounded-sm p-15 p-lg-15 d-flex " style="flex-wrap: nowrap;  align-items: center; justify-content: flex-start;  flex-direction: row;background-color:#fff;">
                       <input type="radio" @if(empty($userCharge) or ($total > $userCharge)) disabled @endif name="gateway" id="offline" value="credit" style="display: block;    visibility: visible;">
                        <img loading="lazy"  src="{{ config('app.img_dynamic_url') }}/assets/default/img/activity/wallet.png" width="120" height="60" alt="">
                        <div>
