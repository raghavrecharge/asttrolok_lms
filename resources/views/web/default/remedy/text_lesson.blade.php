            ...
            <div class="col-12 col-lg-8">
                <div class="post-show mt-30">
                    ...
                    <div class="post-img pb-30">
                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ url($textLesson->image) }}" alt="{{ $textLesson->title }}"/>
                    </div>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
                    <div class="teacher-avatar mt-5">
                        <img loading="lazy" src="{{ config('app.img_dynamic_url') }}{{ $course->teacher->getAvatar(100) }}" class="img-cover" alt="{{ $course->teacher->full_name }}">
                    </div>
