...
@push('styles_top')
    ...
    <link rel="stylesheet" href="{{ config('app.js_css_url') }}/assets/vendors/leaflet/leaflet.markercluster/markerCluster.css">
    <link rel="stylesheet" href="{{ config('app.js_css_url') }}/assets/vendors/leaflet/leaflet.markercluster/markerCluster.Default.css">
...
@push('scripts_bottom')
    ...
    <script defer  src="{{ config('app.js_css_url') }}/assets/vendors/leaflet/leaflet.min.js"></script>
    <script defer  src="{{ config('app.js_css_url') }}/assets/vendors/leaflet/leaflet.markercluster/leaflet.markercluster-src.js"></script>
    ...
    <script defer  src="{{ config('app.js_css_url') }}/assets/default/js/parts/get-regions.min.js"></script>
    <script defer  src="{{ config('app.js_css_url') }}/assets/default/js/parts/instructor-finder-wizard.min.js"></script>
    <script defer  src="{{ config('app.js_css_url') }}/assets/default/js/parts/instructors.min.js"></script>

    <script defer  src="{{ config('app.js_css_url') }}/assets/default/js/parts/instructor-finder.min.js"></script>
@endpush
