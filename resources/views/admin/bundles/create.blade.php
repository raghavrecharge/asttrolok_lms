                                ...
                                @if(!empty($bundle))
                                    ...
                                    <section class="mt-40">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="bundleAddNewProducts" type="button" class="btn btn-primary btn-sm mt-3">{{ trans('update.add_new_product1') }}</button>
                                        </div>
                                                ...
                                                @if(!empty($bundleWebinars) and !$bundleWebinars->isEmpty())
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($bundleWebinars as $bundleWebinar)
                                                                @if(!empty($bundleWebinar->product->title))
                                                                    <tr>
                                                                        <th>{{ $bundleWebinar->product->title }}</th>
                                                                        <td class="text-left">{{ $bundleWebinar->product->creator->full_name }}</td>
                                                                        <td>{{  handlePrice($bundleWebinar->product->price) }}</td>
                                                                        <td>{{ dateTimeFormat($bundleWebinar->product->created_at,'j F Y | H:i') }}</td>

                                                                        <td>
                                                                            <button type="button" data-item-id="{{ $bundleWebinar->id }}" data-bundle-id="{{ !empty($bundle) ? $bundle->id : '' }}" class="edit-bundle-products btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
                                     ...
                                     <section class="mt-40">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="bundleAddNewConsultation" type="button" class="btn btn-primary btn-sm mt-3">{{ trans('update.add_new_consultation') }}</button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($bundleWebinars as $bundleWebinar)
                                                                @if(!empty($bundleWebinar->consultation_type))
                                                                    <tr>
                                                                        <th>{{ $bundleWebinar->consultation_type }}</th>
                                                                        @if($bundleWebinar->consultation_type == 'specific')
                                                                        <td class="text-left">{{optional($userConsultants->firstWhere('id', $bundleWebinar->consultant_id ))->full_name}}</td>
                                                                        @else
                                                                        <td class="text-left"></td>
                                                                        @endif
                                                                        <td>{{ $bundleWebinar->starting_price}} - {{ $bundleWebinar->ending_price }}</td>
                                                                        @if($bundleWebinar->slot_time == 'both')
                                                                        <td>30min ,15min</td>
                                                                        @else
                                                                        <td>{{$bundleWebinar->slot_time}} min</td>
                                                                         @endif
                                                                        <td>
                                                                            <button type="button" data-item-id="{{ $bundleWebinar->id }}" data-bundle-id="{{ !empty($bundle) ? $bundle->id : '' }}" class="edit-bundle-consultation btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
