                ...
                @can('admin_settings_sidebanner')
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                <h4>{{ trans('admin/main.sidebanner_card_title') }}</h4>
                                <p>{{ trans('admin/main.sidebanner_card_hint') }}</p>
                                <a href="/admin/settings/sidebanner" class="card-cta">{{ trans('admin/main.change_setting') }}<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                @endcan
