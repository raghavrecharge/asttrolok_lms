                                        ...
                                        <tr>
                                            ...
                                            <td width="150">
                                                ...
                                                @can('admin_featured_topics_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/recommended-topics/{{ $recommended->id }}/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endcan

                                                @can('admin_featured_topics_delete')
                                                    @include('admin.includes.delete_button',['url' => getAdminPanelUrl().'/recommended-topics/'. $recommended->id .'/delete','btnClass' => 'btn-sm','icon' => true])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
