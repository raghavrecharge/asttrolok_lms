                    ...
                    <form method="post" action="" id="templateForm" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-info pull-left" id="preview" type="button" data-action="{{ getAdminPanelUrl() }}/certificates/templates/preview">{{ trans('admin/main.preview_certificate') }}</button>
                            </div>
                        </div>
