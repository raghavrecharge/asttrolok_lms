    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <p class="">
                        <span class="font-weight-bold">{{ trans('update.bundle_title') }}</span>:
                        {{ $bundle->title }}
                    </p>

                    <form method="post" action="{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/sendNotification" class="form-horizontal form-bordered mt-4">
                        {{ csrf_field() }}
