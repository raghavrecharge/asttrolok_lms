    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if($authUser->can('admin_webinars') or
                $authUser->can('admin_remedies') or
                $authUser->can('admin_bundles') or
                $authUser->can('admin_subscriptions') or
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'webinar') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['webinars']) and $sidebarBeeps['webinars']) beep beep-sidebar @endif" href="{{ getAdminPanelUrl() }}/webinars?type=webinar">Live Classes</a>
                            </li>

                            <li class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'course') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['courses']) and $sidebarBeeps['courses']) beep beep-sidebar @endif" href="{{ getAdminPanelUrl() }}/webinars?type=course">Video Courses</a>
                            </li>

                            <li class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'upcoming') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['upcoming']) and $sidebarBeeps['upcoming']) beep beep-sidebar @endif" href="{{ getAdminPanelUrl() }}/webinars?type=upcoming">Upcoming Courses</a>
                            </li>
                        @endcan()
...
<!--mayank-->
            @can('admin_remedies')
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_remedies_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/remedies', false)) and request()->get('type') == 'course') ? 'active' : '' }}">
                                <a class="nav-link"  href="{{ getAdminPanelUrl() }}/remedies?type=remedy">{{ trans('admin/main.remedies') }}</a>
                            </li>

                            <li class="{{ (request()->is(getAdminPanelUrl('/remedies/create', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/remedies/create">{{ trans('admin/main.new') }}</a>
                            </li>

                            <!--<li class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'webinar') ? 'active' : '' }}">-->
                            <!--    <a class="nav-link @if(!empty($sidebarBeeps['webinars']) and $sidebarBeeps['webinars']) beep beep-sidebar @endif" href="{{ getAdminPanelUrl() }}/webinars?type=webinar">{{ trans('admin/main.admin_remedies_create') }}</a>-->
                            <!--</li> -->
                        ...
                        <!-- @can('admin_remedies_create')-->
                        <!--    <li class="{{ (request()->is(getAdminPanelUrl('/webinars/create', false))) ? 'active' : '' }}">-->
                        <!--        <a class="nav-link" href="{{ getAdminPanelUrl() }}/webinars/create">{{ trans('admin/main.admin_remedies_create') }}</a>-->
                        <!--    </li>-->
                        <!--@endcan() -->
...
<!--mayank end-->
            ...
            @can('admin_events')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/events*', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_events_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/events', false))) ? 'active' : '' }}">
                                <a href="{{ getAdminPanelUrl() }}/events" class="nav-link">Event Lists</a>
                            </li>
                        @endcan

                        @can('admin_events_create')
                            <li class="{{ (request()->is(getAdminPanelUrl('/events/create', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/events/create">Create Event</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('admin_subscriptions')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/subscriptions*', false)) and !request()->is(getAdminPanelUrl('/subscriptions/comments*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-cube"></i>
                        <span>{{ trans('update.subscriptions') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        @can('admin_subscriptions_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/subscriptions', false)) and request()->get('type') == 'course') ? 'active' : '' }}">
                                <a href="{{ getAdminPanelUrl() }}/subscriptions" class="nav-link @if(!empty($sidebarBeeps['subscriptions']) and $sidebarBeeps['subscriptions']) beep beep-sidebar @endif">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()

                        @can('admin_subscriptions_create')
                            <li class="{{ (request()->is(getAdminPanelUrl('/subscriptions/create', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/subscriptions/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/forums*', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @endcan()
                         @can('admin_forum_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/forums', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/forums/0/topics">Topics/{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_supports')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/supports*', false)) and request()->get('type') != 'course_conversations') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_supports_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/supports/newsuportforasttrolok', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/supports/newsuportforasttrolok/support">All supports ticket</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_supports_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/supports/quick-support-form', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/supports/quick-support-form">Quick Support Form</a>
                            </li>
                        @endcan
            ...
            @can('admin_comments')
                <li class="nav-item dropdown {{ (!request()->is(getAdminPanelUrl('admin/comments/products, false')) and (request()->is(getAdminPanelUrl('/comments*', false)) and !request()->is(getAdminPanelUrl('/comments/webinars/reports', false)))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_subscription_comments')
                            <li class="{{ (request()->is(getAdminPanelUrl('/comments/subscriptions', false))) ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['subscriptionComments']) and $sidebarBeeps['subscriptionComments']) beep beep-sidebar @endif" href="{{ getAdminPanelUrl() }}/comments/subscriptions">{{ trans('update.subscription_comments') }}</a>
                            </li>
                        @endcan
