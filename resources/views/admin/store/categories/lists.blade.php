                    ...
                    <div class="card">
                        <div class="card-header">
                            @can('admin_store_categories_create')
                                <a href="{{ getAdminPanelUrl() }}/store/categories/create" class="btn btn-primary">{{ trans('admin/main.add_new') }}</a>
                            @endcan
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_store_categories_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/store/categories/{{ $category->id }}/edit"
                                                       class="btn-transparent btn-sm text-primary">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endcan
                                                @can('admin_store_categories_delete')
                                                    @include('admin.includes.delete_button',['url' => getAdminPanelUrl().'/store/categories/'.$category->id.'/delete'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
