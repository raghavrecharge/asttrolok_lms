                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @can("admin_comments_status")
                                                            <a href="{{ getAdminPanelUrl("/comments/product_reviews/{$reply->id}/toggle") }}" class="btn-transparent text-primary">
                                                        ...
                                                        @can("admin_comments_edit")
                                                            <a href="{{ getAdminPanelUrl("/comments/product_reviews/{$reply->id}/edit") }}" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
