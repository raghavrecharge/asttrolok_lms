                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th>{{ trans('admin/main.address') }}</th>
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                          ...
                                          <td style="min-width: 285px;">
                                                @if(!empty($order->sale->orderAddress))
                                                    <span class="">{{ $order->sale->orderAddress->Address }}, {{ $order->sale->orderAddress->City }}, {{ $order->sale->orderAddress->PostalCode }}, {{ $order->sale->orderAddress->StateProvince }}, {{ $order->sale->orderAddress->Country }}</span>
                                                @endif
                                          </td>
                                            <td>
