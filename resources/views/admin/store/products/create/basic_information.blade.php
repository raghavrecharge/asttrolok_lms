<section>
    ...
    <div class="row">
        <div class="col-12 col-md-5">
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('admin/main.tax') }} (India)</label>
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('admin/main.tax') }} (International)</label>
                <input type="text" name="tax_international" value="{{ !empty($product) ? $product->tax_international : old('tax_international') }}" class="form-control @error('tax_international')  is-invalid @enderror" placeholder=""/>
                <div class="text-muted text-small mt-1">{{ trans('update.product_tax_hint') }}</div>
                @error('tax_international')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                @enderror
