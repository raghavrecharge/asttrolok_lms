                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!--    <li class="nav-item">-->
                            <!--        <a class="nav-link active" id="socials-tab" data-toggle="tab" href="#socials" role="tab" aria-controls="socials" aria-selected="true">{{ trans('admin/main.socials') }}</a>-->
                            <!--    </li>-->
                            ...
                            <div class="tab-content" id="myTabContent2">
                               {{-- @include('admin.settings.general.basic',['itemValue' => (!empty($settings) and !empty($settings['general'])) ? $settings['general']->value : '']) --}}
                                @include('admin.testimonials.video.socials',['itemValue' => (!empty($settings) and !empty($settings['video'])) ? $settings['video']->value : ''])
