                    ...
                    @foreach($users as $user)
                        ...
                        <tr>
                            ...
                            <td class="text-center mb-2" width="120">
                                ...
                                @can('admin_users_not_access_content_toggle')
                                    <a href="{{ getAdminPanelUrl() }}/users/not-access-to-content/{{ $user->id }}/active" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.active') }}">
