                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('admin_quizzes_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/quizzes/{{ $quiz->id }}/edit" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                ...
                                                @can('admin_quizzes_delete')
                                                    @include('admin.includes.delete_button',['url' => getAdminPanelUrl().'/quizzes/'.$quiz->id.'/delete' , 'btnClass' => 'btn-sm'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
