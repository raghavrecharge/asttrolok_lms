                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingClasses['webinars'] as $getTopSellingClass)
                                    <tr>
                                        ...
                                        <td>{{ $getTopSellingClass->sales_count + $getTopSellingClasses['webinarPartTotal'][$getTopSellingClass->id]['count']+ $getTopSellingClasses['webinarInstallmentTotal'][$getTopSellingClass->id]['count']}}</td>
                                        <td>{{ handlePrice($getTopSellingClass->sales_amount + $getTopSellingClasses['webinarPartTotal'][$getTopSellingClass->id]['amount']+ $getTopSellingClasses['webinarInstallmentTotal'][$getTopSellingClass->id]['amount']) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ getAdminPanelUrl() }}/consultants?sort=appointments_desc" class="btn btn-sm btn-primary">{{trans('admin/main.view_more')}}<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ getAdminPanelUrl() }}/instructors?sort=sales_classes_desc" class="btn btn-sm btn-primary">{{trans('admin/main.view_more')}}<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingTeachers['users'] as $getTopSellingTeacher)
                                    <tr>
                                        ...
                                        <td>{{ $getTopSellingTeacher->sales_count + $getTopSellingTeachers['usersdata'][$getTopSellingTeacher->id]['count']  }}</td>
                                        <td>{{ handlePrice($getTopSellingTeacher->sales_amount + $getTopSellingTeachers['usersdata'][$getTopSellingTeacher->id]['amount']) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
            ...
            <div class="col-md-4">
                {{--<div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ getAdminPanelUrl() }}/organizations?sort=sales_classes_desc" class="btn btn-sm btn-primary">{{trans('admin/main.view_more')}}<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
