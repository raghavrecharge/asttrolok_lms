                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_registration_packages_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/financial/registration-packages/{{ $package->id }}/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endcan

                                                @can('admin_registration_packages_delete')
                                                    @include('admin.includes.delete_button',['url' => getAdminPanelUrl().'/financial/registration-packages/'. $package->id.'/delete','btnClass' => 'btn-sm'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
