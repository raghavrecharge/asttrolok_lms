                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_subscribe_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/financial/subscribes/{{ $subscribe->id }}/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endcan

                                                @can('admin_subscribe_delete')
                                                    @include('admin.includes.delete_button',['url' => getAdminPanelUrl().'/financial/subscribes/'. $subscribe->id.'/delete','btnClass' => 'btn-sm'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
