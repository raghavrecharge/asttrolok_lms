                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="category" name="category" value="{{ old('category') }}" placeholder="e.g. Workshop, Seminar, Webinar">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="max_participants" name="max_participants" value="{{ old('max_participants', 100) }}" min="1" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="location" class="form-label">Location</label>
                                                <input type="text" class="form-control" id="location" name="location" value="{{ old('location') }}" placeholder="e.g. Online, Delhi, Mumbai">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" class="form-control" id="registration_deadline" name="registration_deadline" value="{{ old('registration_deadline') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="alert alert-info">
                                                ...
                                                <p class="mb-0 small">After creating the event, a unique payment link will be automatically generated. You can copy and share this link with participants.</p>
                                            </div>
