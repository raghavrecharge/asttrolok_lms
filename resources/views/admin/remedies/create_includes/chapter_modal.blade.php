<div id="chapterModalHtml" class="d-none">
    <div class="custom-modal-body">
        ...
        <div class="js-content-form chapter-form mt-20" data-action="{{ getAdminPanelUrl() }}/rechapter/store">

            <input type="hidden" name="ajax[chapter][remedy_id]" class="js-chapter-remedy-id" value="{{ $remedy->id }}">
