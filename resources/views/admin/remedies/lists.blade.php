                ...
                @if($classesType == 'remedy')
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('admin/main.inprogress_remedies')}}</h4>
                                </div>
                                <div class="card-body">
                                    {{ $inProgressRemedies }}
                                </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            @can('admin_webinars_export_excel')
                                <div class="text-right">
                                    <!--<a href="{{ getAdminPanelUrl() }}/remedies/excel?{{ http_build_query(request()->all()) }}" class="btn btn-primary">{{ trans('admin/main.export_xls') }}</a>-->
                                </div>
                            @endcan
                        </div>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td width="18%" class="text-left">
                                                ...
                                                @if(!empty($remedy->category->title))
                                                    <div class="text-small">{{ $remedy->category->title }}</div>
                                                @else
                                            ...
                                            <td>
                                                @switch($remedy->status)
                                                    ...
                                                    @case(\App\Models\Remedy::$isDraft)
                                                        ...
                                                        @break
                                                    @case(\App\Models\Remedy::$pending)
                                                        <span class="text-warning">{{ trans('admin/main.waiting') }}</span>
                                                        @break
                                                    @case(\App\Models\Remedy::$inactive)
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinars_edit')
                                                            @if($remedy->status == \App\Models\Remedy::$pending)
                                                                @include('admin.includes.delete_button',[
                                                                    'url' => getAdminPanelUrl().'/remedies/'.$remedy->id.'/approve',
                                                                ...
                                                                @include('admin.includes.delete_button',[
                                                                    'url' => getAdminPanelUrl().'/remedies/'.$remedy->id.'/reject',
                                                            ...
                                                            @elseif($remedy->status == \App\Models\Remedy::$active)
                                                                @include('admin.includes.delete_button',[
                                                                    'url' => getAdminPanelUrl().'/remedies/'.$remedy->id.'/unpublish',
                                                                    'btnClass' => 'd-flex align-items-center text-danger text-decoration-none btn-transparent btn-sm mt-1',
                                                        ...
                                                        @can('admin_webinars_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/remedies/{{ $remedy->id }}/edit" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.edit') }}">
                        ...
                        <div class="card-footer text-center">
                            {{ $remedies->appends(request()->input())->links() }}
                        </div>
