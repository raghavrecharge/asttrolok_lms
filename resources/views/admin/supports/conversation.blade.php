                                    ...
                                    <div class="chat-details">
                                        ...
                                        <div class="chat-time">
                                            ...
                                            @if(!empty($conversations->attach))
                                                <a href="https://storage.googleapis.com/astrolok{{ $conversations->attach }}" target="_blank" class="text-success"><i class="fa fa-paperclip"></i> {{ trans('admin/main.open_attach') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
