                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ handlePrice($allAffiliateAmounts) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ handlePrice($allAffiliateCommissionAmounts) }}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            @can('admin_referrals_export')
                                <div class="text-right">
                                    <a href="{{ getAdminPanelUrl() }}/referrals/excel?type=history" class="btn btn-primary">{{ trans('admin/main.export_xls') }}</a>
                                </div>
                            @endcan
                        </div>
                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    @foreach($affiliates as $affiliate)
                                        <tr>
                                            ...
                                            <td>{{ handlePrice($affiliate->getReferredAmount()) }}</td>
