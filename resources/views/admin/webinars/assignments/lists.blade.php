                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    @can('admin_reviews_status_toggle')
                                        <a href="{{ getAdminPanelUrl() }}/assignments/{{ $assignment->id }}/students" class="btn-transparent text-primary mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('public.students') }}">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </a>
                                    @endcan

                                    <a href="{{ getAdminPanelUrl() }}/webinars/{{ $assignment->webinar_id }}/edit" target="_blank" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.course') }}">
