<?php
// Import asttrolok_live.sql to XAMPP MySQL
$host = '127.0.0.1';
$port = 3306;
$user = 'root';
$password = 'root123';
$database = 'asttrolok_live';
...
try {
    ...
    echo "\n✅ asttrolok_live database imported successfully!\n";
    echo "Database: $database\n";
    echo "Ready for XAMPP configuration!\n";
